...
#define KEFIR_PARSER_RULESET_EXTRA_SLOT_OFFSET KEFIR_PARSER_RULESET_PREDEFINED_COUNT
#define KEFIR_PARSER_RULESET_EXTRA_SLOTS 128
#define KEFIR_PARSER_RULESET_CAPACITY (KEFIR_PARSER_RULESET_EXTRA_SLOT_OFFSET + KEFIR_PARSER_RULESET_EXTRA_SLOTS)
