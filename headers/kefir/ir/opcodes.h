...
typedef enum kefir_iropcode {
    ...
    KEFIR_IROPCODE_POP = 0x12,
    KEFIR_IROPCODE_PICK = 0x13,
    KEFIR_IROPCODE_PUT = 0x14,
    KEFIR_IROPCODE_INSERT = 0x15,
    KEFIR_IROPCODE_XCHG = 0x16,
    KEFIR_IROPCODE_DROP = 0x17,
    ...
    KEFIR_IROPCODE_F64ADD = 0x76,
    KEFIR_IROPCODE_F64SUB = 0x77,
    KEFIR_IROPCODE_F64MUL = 0x78,
    KEFIR_IROPCODE_F64DIV = 0x79,
    ...
    KEFIR_IROPCODE_F32CF64 = 0x94,
    KEFIR_IROPCODE_F64CF32 = 0x95
} kefir_iropcode_t;
