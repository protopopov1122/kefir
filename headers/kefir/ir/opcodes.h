...
typedef enum kefir_iropcode {
    ...
    KEFIR_IROPCODE_EXTUBITS = 0x61,
    KEFIR_IROPCODE_EXTSBITS = 0x62,
    KEFIR_IROPCODE_INSERTBITS = 0x63,
    KEFIR_IROPCODE_LOAD24U = 0x64,
    KEFIR_IROPCODE_LOAD40U = 0x65,
    KEFIR_IROPCODE_LOAD48U = 0x66,
    KEFIR_IROPCODE_LOAD56U = 0x67,
