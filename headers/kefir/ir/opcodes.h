...
typedef enum kefir_iropcode {
    ...
    KEFIR_IROPCODE_STORE8 = 0x5f,
    KEFIR_IROPCODE_STORE16 = 0x60,
    KEFIR_IROPCODE_STORE24 = 0x61,
    KEFIR_IROPCODE_STORE32 = 0x62,
    KEFIR_IROPCODE_STORE40 = 0x63,
    KEFIR_IROPCODE_STORE48 = 0x64,
    KEFIR_IROPCODE_STORE56 = 0x65,
    KEFIR_IROPCODE_STORE64 = 0x66,
    KEFIR_IROPCODE_BZERO = 0x67,
    KEFIR_IROPCODE_BCOPY = 0x68,
    KEFIR_IROPCODE_EXTUBITS = 0x69,
    KEFIR_IROPCODE_EXTSBITS = 0x6a,
    KEFIR_IROPCODE_INSERTBITS = 0x6b,
    KEFIR_IROPCODE_GETTHRLOCAL = 0x6c,
