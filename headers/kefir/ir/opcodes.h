...
typedef enum kefir_iropcode {
    ...
    // Stack control
    KEFIR_IROPCODE_PUSHI64,
    KEFIR_IROPCODE_PUSHU64,
    KEFIR_IROPCODE_POP,
    KEFIR_IROPCODE_PICK,
    KEFIR_IROPCODE_PUT,
    ...
    KEFIR_IROPCODE_F32EQUALS,
    KEFIR_IROPCODE_F32GREATER,
    KEFIR_IROPCODE_F32LESSER,
    KEFIR_IROPCODE_F64EQUALS,
    KEFIR_IROPCODE_F64GREATER,
    KEFIR_IROPCODE_F64LESSER,

    // Floating-pointer conversions
    KEFIR_IROPCODE_F32CINT,
    KEFIR_IROPCODE_F64CINT,
    KEFIR_IROPCODE_INTCF32,
    KEFIR_IROPCODE_INTCF64,
    KEFIR_IROPCODE_F32CF64,
    KEFIR_IROPCODE_F64CF32
} kefir_iropcode_t;
