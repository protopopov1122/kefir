...
ANALYZE_NODE(builtin, struct kefir_ast_builtin);
ANALYZE_NODE(label_address, struct kefir_ast_label_address);
ANALYZE_NODE(statement_expression, struct kefir_ast_statement_expression);
