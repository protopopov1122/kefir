...
kefir_result_t kefir_ast_translator_function_declaration_init(
    ...
    const struct kefir_ast_type_traits *, struct kefir_ir_module *, struct kefir_ast_translator_type_resolver *,
    const char *, const struct kefir_ast_type *, const struct kefir_list *,
