...
kefir_result_t kefir_ast_translator_scoped_identifier_remove(struct kefir_mem *,
                                                         struct kefir_list *,
                                                         struct kefir_list_entry *,
                                                         void *);

kefir_result_t kefir_ast_translator_scoped_identifier_insert(struct kefir_mem *,
                                                         const char *,
