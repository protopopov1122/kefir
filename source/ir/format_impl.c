...
kefir_result_t kefir_ir_format_instr(struct kefir_json_output *json, const struct kefir_ir_module *module, const struct kefir_irinstr *instr) {
    ...
    switch (instr->opcode) {
        ...
        case KEFIR_IROPCODE_STORE24: return kefir_ir_format_instr_none(json, module, instr);
        case KEFIR_IROPCODE_STORE32: return kefir_ir_format_instr_none(json, module, instr);
        case KEFIR_IROPCODE_STORE40: return kefir_ir_format_instr_none(json, module, instr);
        case KEFIR_IROPCODE_STORE48: return kefir_ir_format_instr_none(json, module, instr);
        case KEFIR_IROPCODE_STORE56: return kefir_ir_format_instr_none(json, module, instr);
