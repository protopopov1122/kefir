...
static struct {
    ...
    HANDLER(LOAD40U),   HANDLER(LOAD48U),    HANDLER(LOAD56U),    HANDLER(LOAD64),    HANDLER(STORE8),
    HANDLER(STORE16),   HANDLER(STORE24),    HANDLER(STORE32),    HANDLER(STORE40),   HANDLER(STORE48),
    HANDLER(STORE56),   HANDLER(STORE64),    HANDLER(BZERO),      HANDLER(BCOPY),     HANDLER(EXTUBITS),
    ...
    HANDLER(LDGREATER), HANDLER(LDLESSER),   HANDLER(F32CINT),    HANDLER(F64CINT),   HANDLER(INTCF32),
    ...
    HANDLER(F64CLD),    HANDLER(LDCF32),     HANDLER(LDCF64)};
