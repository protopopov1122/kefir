...
static struct {
    ...
    HANDLER(F64LESSER), HANDLER(LDEQUALS),   HANDLER(LDGREATER),  HANDLER(LDLESSER),   HANDLER(F32CINT),
    HANDLER(F64CINT),   HANDLER(INTCF32),    HANDLER(INTCF64),    HANDLER(UINTCF32),   HANDLER(UINTCF64),
    HANDLER(F32CF64),   HANDLER(F64CF32),    HANDLER(ALLOCA),     HANDLER(INTCLD),     HANDLER(UINTCLD),
    HANDLER(LDCINT),    HANDLER(F32CLD),     HANDLER(F64CLD),     HANDLER(LDCF32),     HANDLER(LDCF64)};
