...
static struct {
    ...
    HANDLER(F64MUL),    HANDLER(F64DIV),     HANDLER(F64NEG),     HANDLER(F32EQUALS), HANDLER(F32GREATER),
    HANDLER(F32LESSER), HANDLER(F64EQUALS),  HANDLER(F64GREATER), HANDLER(F64LESSER), HANDLER(F32CINT),
    HANDLER(F64CINT),   HANDLER(INTCF32),    HANDLER(INTCF64),    HANDLER(UINTCF32),  HANDLER(UINTCF64),
    HANDLER(F32CF64),   HANDLER(F64CF32),    HANDLER(ALLOCA)};
