...
static kefir_result_t vararg_classify_nested_argument(const struct kefir_codegen_amd64_sysv_builtin_type *builtin_type,
                                    const struct kefir_ir_typeentry *typeentry,
...
static kefir_result_t vararg_classify_immediate_argument(const struct kefir_codegen_amd64_sysv_builtin_type *builtin_type,
                                       const struct kefir_ir_typeentry *typeentry,
                                       struct kefir_amd64_sysv_parameter_allocation *allocation) {
    UNUSED(builtin_type);
    UNUSED(typeentry);
...
static kefir_result_t vararg_allocate_immediate_argument(const struct kefir_codegen_amd64_sysv_builtin_type *builtin_type,
                                       const struct kefir_ir_typeentry *typeentry,
