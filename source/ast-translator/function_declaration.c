...
static kefir_result_t kefir_ast_translator_function_declaration_alloc(struct kefir_mem *mem,
    ...
    kefir_result_t res = kefir_ast_translator_function_declaration_alloc_args(mem, env, func_type, func_decl);
    REQUIRE_ELSE(res == KEFIR_OK, {
...
kefir_result_t kefir_ast_translator_function_declaration_init(struct kefir_mem *mem,
    ...
    kefir_result_t res = kefir_ast_translator_function_declaration_alloc(mem, env, module, func_type, function_declaration);
    REQUIRE_ELSE(res == KEFIR_OK, {
