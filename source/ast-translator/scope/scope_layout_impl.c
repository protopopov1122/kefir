...
kefir_result_t kefir_ast_translator_scoped_identifier_remove(struct kefir_mem *mem,
...
kefir_result_t kefir_ast_translator_scoped_identifier_insert(struct kefir_mem *mem,
