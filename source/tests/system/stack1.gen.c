...
kefir_result_t kefir_int_test(struct kefir_mem *mem) {
    ...
    kefir_irbuilder_block_append(mem, &func->body, KEFIR_IROPCODE_INSERT, 0);
    ...
    kefir_irbuilder_type_append_v(mem, func->declaration->params, KEFIR_IR_TYPE_LONG, 0, 0);
    kefir_irbuilder_type_append_v(mem, func->declaration->result, KEFIR_IR_TYPE_LONG, 0, 0);
    kefir_irbuilder_block_append(mem, &func->body, KEFIR_IROPCODE_INSERT, 1);
    kefir_irbuilder_block_append(mem, &func->body, KEFIR_IROPCODE_RET, 0);
    ...
    kefir_irbuilder_type_append_v(mem, func->declaration->params, KEFIR_IR_TYPE_LONG, 0, 0);
    kefir_irbuilder_type_append_v(mem, func->declaration->result, KEFIR_IR_TYPE_LONG, 0, 0);
    kefir_irbuilder_block_append(mem, &func->body, KEFIR_IROPCODE_INSERT, 2);
    kefir_irbuilder_block_append(mem, &func->body, KEFIR_IROPCODE_INSERT, 2);
    kefir_irbuilder_block_append(mem, &func->body, KEFIR_IROPCODE_RET, 0);
    ...
    kefir_irbuilder_type_append_v(mem, func->declaration->params, KEFIR_IR_TYPE_LONG, 0, 0);
    kefir_irbuilder_type_append_v(mem, func->declaration->result, KEFIR_IR_TYPE_LONG, 0, 0);
    kefir_irbuilder_block_append(mem, &func->body, KEFIR_IROPCODE_XCHG, 0);
    kefir_irbuilder_block_append(mem, &func->body, KEFIR_IROPCODE_RET, 0);
    ...
    kefir_irbuilder_type_append_v(mem, func->declaration->params, KEFIR_IR_TYPE_LONG, 0, 0);
    kefir_irbuilder_type_append_v(mem, func->declaration->result, KEFIR_IR_TYPE_LONG, 0, 0);
    kefir_irbuilder_block_append(mem, &func->body, KEFIR_IROPCODE_XCHG, 1);
    kefir_irbuilder_block_append(mem, &func->body, KEFIR_IROPCODE_RET, 0);
    ...
    kefir_irbuilder_type_append_v(mem, func->declaration->params, KEFIR_IR_TYPE_LONG, 0, 0);
    kefir_irbuilder_type_append_v(mem, func->declaration->result, KEFIR_IR_TYPE_LONG, 0, 0);
    kefir_irbuilder_block_append(mem, &func->body, KEFIR_IROPCODE_XCHG, 2);
    kefir_irbuilder_block_append(mem, &func->body, KEFIR_IROPCODE_RET, 0);
    ...
    kefir_irbuilder_type_append_v(mem, func->declaration->params, KEFIR_IR_TYPE_LONG, 0, 0);
    kefir_irbuilder_type_append_v(mem, func->declaration->result, KEFIR_IR_TYPE_LONG, 0, 0);
    kefir_irbuilder_block_append(mem, &func->body, KEFIR_IROPCODE_DROP, 0);
    kefir_irbuilder_block_append(mem, &func->body, KEFIR_IROPCODE_RET, 0);
    ...
    kefir_irbuilder_type_append_v(mem, func->declaration->params, KEFIR_IR_TYPE_LONG, 0, 0);
    kefir_irbuilder_type_append_v(mem, func->declaration->result, KEFIR_IR_TYPE_LONG, 0, 0);
    kefir_irbuilder_block_append(mem, &func->body, KEFIR_IROPCODE_DROP, 1);
    kefir_irbuilder_block_append(mem, &func->body, KEFIR_IROPCODE_RET, 0);
