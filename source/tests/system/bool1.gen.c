...
kefir_result_t kefir_int_test(struct kefir_mem *mem) {
    ...
    struct kefir_ir_type *decl_params = kefir_ir_module_new_type(mem, &module, 2),
                       *decl_result = kefir_ir_module_new_type(mem, &module, 1);
    REQUIRE(decl_params != NULL, KEFIR_INTERNAL_ERROR);
    REQUIRE(decl_result != NULL, KEFIR_INTERNAL_ERROR);
    struct kefir_ir_function_decl decl;
    kefir_ir_function_t func;
    kefir_ir_function_decl_alloc(mem, "bool_and", decl_params, decl_result, &decl);
    ...
    REQUIRE(decl_params != NULL, KEFIR_INTERNAL_ERROR);
    REQUIRE(decl_result != NULL, KEFIR_INTERNAL_ERROR);
    kefir_ir_function_decl_alloc(mem, "bool_or", decl_params, decl_result, &decl);
    kefir_ir_function_alloc(mem, &decl, 1024, &func);
    kefir_ir_type_append_v(func.declaration->params, KEFIR_IR_TYPE_BOOL, 0, 0);
    kefir_ir_type_append_v(func.declaration->params, KEFIR_IR_TYPE_BOOL, 0, 0);
    kefir_ir_type_append_v(func.declaration->result, KEFIR_IR_TYPE_BOOL, 0, 0);
    ...
    REQUIRE(decl_params != NULL, KEFIR_INTERNAL_ERROR);
    REQUIRE(decl_result != NULL, KEFIR_INTERNAL_ERROR);
    kefir_ir_function_decl_alloc(mem, "bool_not", decl_params, decl_result, &decl);
    kefir_ir_function_alloc(mem, &decl, 1024, &func);
    kefir_ir_type_append_v(func.declaration->params, KEFIR_IR_TYPE_BOOL, 0, 0);
    kefir_ir_type_append_v(func.declaration->result, KEFIR_IR_TYPE_BOOL, 0, 0);
