...
kefir_result_t kefir_int_test(struct kefir_mem *mem) {
    ...
    kefir_irfunction_alloc(mem, "trunc1", 1, 1, 1024, &func);
    ...
    kefir_irfunction_alloc(mem, "extend8", 1, 1, 1024, &func);
    kefir_ir_type_append_v(&func.declaration.params, KEFIR_IR_TYPE_LONG, 0, 0);
    ...
    kefir_irfunction_alloc(mem, "extend16", 1, 1, 1024, &func);
    kefir_ir_type_append_v(&func.declaration.params, KEFIR_IR_TYPE_LONG, 0, 0);
    ...
    kefir_irfunction_alloc(mem, "extend32", 1, 1, 1024, &func);
    kefir_ir_type_append_v(&func.declaration.params, KEFIR_IR_TYPE_LONG, 0, 0);
