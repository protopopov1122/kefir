...
kefir_result_t kefir_int_test(struct kefir_mem *mem) {
    ...
    kefir_irbuilder_block_append(mem, &proxyadd->body, KEFIR_IROPCODE_PUSH, 7);
    kefir_irbuilder_block_append(mem, &proxyadd->body, KEFIR_IROPCODE_XCHG, 1);
    kefir_irbuilder_block_append(mem, &proxyadd->body, KEFIR_IROPCODE_INVOKEV, addstruct_id);
