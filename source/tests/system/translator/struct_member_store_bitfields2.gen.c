...
static kefir_result_t define_assign_function(struct kefir_mem *mem,
    ...
    REQUIRE_OK(kefir_ast_comma_append(mem, comma, KEFIR_AST_NODE_BASE(kefir_ast_new_simple_assignment(mem,
...
static kefir_result_t generate_ir(struct kefir_mem *mem, struct kefir_ir_module *module, struct kefir_ir_target_platform *ir_platform) {
    ...
    REQUIRE_OK(kefir_ast_struct_type_bitfield(mem, context_manager.current->symbols, struct_type1,
        "x", kefir_ast_type_unsigned_int(), NULL, kefir_ast_constant_expression_integer(mem, 11)));
    REQUIRE_OK(kefir_ast_struct_type_bitfield(mem, context_manager.current->symbols, struct_type1,
        NULL, kefir_ast_type_unsigned_int(), NULL, kefir_ast_constant_expression_integer(mem, 5)));
    REQUIRE_OK(kefir_ast_struct_type_bitfield(mem, context_manager.current->symbols, struct_type1,
        "y", kefir_ast_type_unsigned_int(), NULL, kefir_ast_constant_expression_integer(mem, 9)));
    REQUIRE_OK(kefir_ast_struct_type_bitfield(mem, context_manager.current->symbols, struct_type1,
        "z", kefir_ast_type_unsigned_char(), NULL, kefir_ast_constant_expression_integer(mem, 7)));
    REQUIRE_OK(kefir_ast_struct_type_bitfield(mem, context_manager.current->symbols, struct_type1,
        NULL, kefir_ast_type_unsigned_long(), NULL, kefir_ast_constant_expression_integer(mem, 19)));
    REQUIRE_OK(kefir_ast_struct_type_bitfield(mem, context_manager.current->symbols, struct_type1,
        "w", kefir_ast_type_unsigned_char(), NULL, kefir_ast_constant_expression_integer(mem, 5)));
    REQUIRE_OK(kefir_ast_struct_type_bitfield(mem, context_manager.current->symbols, struct_type1,
        "k", kefir_ast_type_unsigned_long(), NULL, kefir_ast_constant_expression_integer(mem, 39)));
