...
DEFFUN(postinc, "postinc", KEFIR_AST_OPERATION_POSTFIX_INCREMENT, kefir_ast_type_float())
DEFFUN(predec, "predec", KEFIR_AST_OPERATION_PREFIX_DECREMENT, kefir_ast_type_float())
DEFFUN(postdec, "postdec", KEFIR_AST_OPERATION_POSTFIX_DECREMENT, kefir_ast_type_float())
