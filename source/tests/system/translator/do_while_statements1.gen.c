...
static kefir_result_t define_conditional_function(struct kefir_mem *mem, struct function *func,
    ...
    struct kefir_ast_declaration *declarationFCurrent = kefir_ast_new_declaration(
    ...
    struct kefir_ast_declaration *declarationFNext = kefir_ast_new_declaration(
    ...
    struct kefir_ast_declaration *declarationFTemp = kefir_ast_new_declaration(
