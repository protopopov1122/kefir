...
#define DEFFUN(_id, _name, _oper)                                                                                    \
    static kefir_result_t define_##_id##_function(struct kefir_mem *mem, struct function *func,                      \
        ...
        REQUIRE_OK(kefir_ast_context_manager_attach_local(&func->local_context, context_manager));                   \
                                                                                                                     \
        REQUIRE_OK(                                                                                                  \
            kefir_ast_local_context_define_auto(mem, context_manager->local, "fn1", param_type, NULL, NULL, NULL));  \
        REQUIRE_OK(                                                                                                  \
            kefir_ast_local_context_define_auto(mem, context_manager->local, "fn2", param_type, NULL, NULL, NULL));  \
