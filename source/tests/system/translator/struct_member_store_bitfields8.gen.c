...
static kefir_result_t define_modify_function(struct kefir_mem *mem,
    ...
    REQUIRE_OK(kefir_ast_type_function_parameter(mem, context_manager->current->type_bundle, func_type,
        NULL, kefir_ast_type_unsigned_long(), NULL));
    ...
    REQUIRE_OK(kefir_ast_local_context_define_auto(mem, context_manager->local, "value",
        kefir_ast_type_unsigned_long(), NULL, NULL));
    ...
    REQUIRE_OK(kefir_ast_comma_append(mem, comma, KEFIR_AST_NODE_BASE(kefir_ast_new_compound_assignment(mem,
        operator,
...
static kefir_result_t generate_ir(struct kefir_mem *mem, struct kefir_ir_module *module, struct kefir_ir_target_platform *ir_platform) {
    ...
    REQUIRE_OK(kefir_ast_struct_type_bitfield(mem, context_manager.current->symbols, struct_type1,
        "a", kefir_ast_type_unsigned_char(), NULL, kefir_ast_constant_expression_integer(mem, 7)));
    REQUIRE_OK(kefir_ast_struct_type_bitfield(mem, context_manager.current->symbols, struct_type1,
        "b", kefir_ast_type_unsigned_short(), NULL, kefir_ast_constant_expression_integer(mem, 15)));
    REQUIRE_OK(kefir_ast_struct_type_bitfield(mem, context_manager.current->symbols, struct_type1,
        "c", kefir_ast_type_unsigned_int(), NULL, kefir_ast_constant_expression_integer(mem, 31)));
    REQUIRE_OK(kefir_ast_struct_type_bitfield(mem, context_manager.current->symbols, struct_type1,
        "d", kefir_ast_type_unsigned_long(), NULL, kefir_ast_constant_expression_integer(mem, 63)));
    REQUIRE_OK(kefir_ast_struct_type_bitfield(mem, context_manager.current->symbols, struct_type1,
        "e", kefir_ast_type_unsigned_int(), NULL, kefir_ast_constant_expression_integer(mem, 31)));
    REQUIRE_OK(kefir_ast_struct_type_bitfield(mem, context_manager.current->symbols, struct_type1,
        "f", kefir_ast_type_unsigned_short(), NULL, kefir_ast_constant_expression_integer(mem, 15)));
    REQUIRE_OK(kefir_ast_struct_type_bitfield(mem, context_manager.current->symbols, struct_type1,
        "g", kefir_ast_type_unsigned_char(), NULL, kefir_ast_constant_expression_integer(mem, 7)));
    REQUIRE_OK(kefir_ast_struct_type_bitfield(mem, context_manager.current->symbols, struct_type1,
        "h", kefir_ast_type_unsigned_long(), NULL, kefir_ast_constant_expression_integer(mem, 33)));
    REQUIRE_OK(kefir_ast_struct_type_bitfield(mem, context_manager.current->symbols, struct_type1,
        "i", kefir_ast_type_unsigned_int(), NULL, kefir_ast_constant_expression_integer(mem, 17)));
    REQUIRE_OK(kefir_ast_struct_type_bitfield(mem, context_manager.current->symbols, struct_type1,
        "j", kefir_ast_type_unsigned_short(), NULL, kefir_ast_constant_expression_integer(mem, 9)));
    
    struct function assign_and, assign_or, assign_xor,
                    assign_shl, assign_shr;
    REQUIRE_OK(define_modify_function(mem, &assign_and, &context_manager, "modify_and", KEFIR_AST_ASSIGNMENT_BITWISE_AND,
    ...
    REQUIRE_OK(define_modify_function(mem, &assign_or, &context_manager, "modify_or", KEFIR_AST_ASSIGNMENT_BITWISE_OR,
        kefir_ast_type_pointer(mem, context_manager.current->type_bundle, type1)));
    REQUIRE_OK(define_modify_function(mem, &assign_xor, &context_manager, "modify_xor", KEFIR_AST_ASSIGNMENT_BITWISE_XOR,
        kefir_ast_type_pointer(mem, context_manager.current->type_bundle, type1)));
    REQUIRE_OK(define_modify_function(mem, &assign_shl, &context_manager, "modify_shl", KEFIR_AST_ASSIGNMENT_SHIFT_LEFT,
        kefir_ast_type_pointer(mem, context_manager.current->type_bundle, type1)));
    REQUIRE_OK(define_modify_function(mem, &assign_shr, &context_manager, "modify_shr", KEFIR_AST_ASSIGNMENT_SHIFT_RIGHT,
        kefir_ast_type_pointer(mem, context_manager.current->type_bundle, type1)));
