...
static kefir_result_t define_conditional_function(struct kefir_mem *mem, struct function *func,
    ...
    struct kefir_ast_declaration *outer_loop_init = kefir_ast_new_declaration(
    ...
    struct kefir_ast_declaration *inner_loop_init = kefir_ast_new_declaration(
    ...
    struct kefir_ast_declaration *temp_variable = kefir_ast_new_declaration(
