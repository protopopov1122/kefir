...
static kefir_result_t generate_ir(struct kefir_mem *mem, struct kefir_ir_module *module, struct kefir_ir_target_platform *ir_platform) {
    ...
    REQUIRE_OK(kefir_ast_struct_type_bitfield(mem, context_manager.current->symbols, struct_type1,
        "field1", kefir_ast_type_signed_long(), NULL, kefir_ast_constant_expression_integer(mem, 9)));
    REQUIRE_OK(kefir_ast_struct_type_bitfield(mem, context_manager.current->symbols, struct_type1,
        "field2", kefir_ast_type_signed_short(), NULL, kefir_ast_constant_expression_integer(mem, 12)));
    REQUIRE_OK(kefir_ast_struct_type_bitfield(mem, context_manager.current->symbols, struct_type1,
        "field3", kefir_ast_type_signed_int(), NULL, kefir_ast_constant_expression_integer(mem, 20)));
    REQUIRE_OK(kefir_ast_struct_type_bitfield(mem, context_manager.current->symbols, struct_type1,
        NULL, kefir_ast_type_signed_char(), NULL, kefir_ast_constant_expression_integer(mem, 0)));
    REQUIRE_OK(kefir_ast_struct_type_bitfield(mem, context_manager.current->symbols, struct_type1,
        NULL, kefir_ast_type_signed_int(), NULL, kefir_ast_constant_expression_integer(mem, 14)));
    REQUIRE_OK(kefir_ast_struct_type_bitfield(mem, context_manager.current->symbols, struct_type1,
        "field4", kefir_ast_type_signed_long(), NULL, kefir_ast_constant_expression_integer(mem, 24)));
    REQUIRE_OK(kefir_ast_struct_type_bitfield(mem, context_manager.current->symbols, struct_type1,
        NULL, kefir_ast_type_signed_char(), NULL, kefir_ast_constant_expression_integer(mem, 6)));
    REQUIRE_OK(kefir_ast_struct_type_bitfield(mem, context_manager.current->symbols, struct_type1,
        "field5", kefir_ast_type_signed_char(), NULL, kefir_ast_constant_expression_integer(mem, 7)));
