...
static kefir_result_t generate_ir(struct kefir_mem *mem, struct kefir_ir_module *module, struct kefir_ir_target_platform *ir_platform) {
    ...
    REQUIRE_OK(kefir_ast_struct_type_bitfield(mem, context_manager.current->symbols, struct_type1,
        "field1", kefir_ast_type_signed_char(), NULL, kefir_ast_constant_expression_integer(mem, 4)));
    REQUIRE_OK(kefir_ast_struct_type_bitfield(mem, context_manager.current->symbols, struct_type1,
        "field2", kefir_ast_type_unsigned_long_long(), NULL, kefir_ast_constant_expression_integer(mem, 2)));
    REQUIRE_OK(kefir_ast_struct_type_bitfield(mem, context_manager.current->symbols, struct_type1,
        "field3", kefir_ast_type_signed_long(), NULL, kefir_ast_constant_expression_integer(mem, 10)));
