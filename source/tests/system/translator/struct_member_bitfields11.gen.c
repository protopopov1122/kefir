...
static kefir_result_t generate_ir(struct kefir_mem *mem, struct kefir_ir_module *module, struct kefir_ir_target_platform *ir_platform) {
    ...
    REQUIRE_OK(kefir_ast_struct_type_bitfield(mem, context_manager.current->symbols, struct_type1,
        "a", kefir_ast_type_signed_long(), NULL, kefir_ast_constant_expression_integer(mem, 31)));
    REQUIRE_OK(kefir_ast_struct_type_bitfield(mem, context_manager.current->symbols, struct_type1,
        "b", kefir_ast_type_signed_long(), NULL, kefir_ast_constant_expression_integer(mem, 33)));
    REQUIRE_OK(kefir_ast_struct_type_bitfield(mem, context_manager.current->symbols, struct_type1,
        "c", kefir_ast_type_signed_long(), NULL, kefir_ast_constant_expression_integer(mem, 31)));
    REQUIRE_OK(kefir_ast_struct_type_bitfield(mem, context_manager.current->symbols, struct_type1,
        NULL, kefir_ast_type_signed_char(), NULL, kefir_ast_constant_expression_integer(mem, 0)));
    REQUIRE_OK(kefir_ast_struct_type_bitfield(mem, context_manager.current->symbols, struct_type1,
        "d", kefir_ast_type_signed_long(), NULL, kefir_ast_constant_expression_integer(mem, 33)));
