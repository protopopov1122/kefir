...
#define DEFFUN(_id, _name, _oper)                                                                                     \
    static kefir_result_t define_##_id##_function(struct kefir_mem *mem, struct function *func,                       \
        ...
        REQUIRE_OK(kefir_ast_context_manager_attach_local(&func->local_context, context_manager));                    \
                                                                                                                      \
        REQUIRE_OK(kefir_ast_local_context_define_auto(mem, context_manager->local, "x",                              \
                                                       kefir_ast_type_unsigned_int(), NULL, NULL, NULL, NULL));       \
        REQUIRE_OK(kefir_ast_local_context_define_auto(mem, context_manager->local, "y",                              \
                                                       kefir_ast_type_unsigned_int(), NULL, NULL, NULL, NULL));       \
                                                                                                                      \
...
static kefir_result_t generate_ir(struct kefir_mem *mem, struct kefir_ir_module *module,
    ...
    struct function sum_func, sub_func, mul_func, div_func, mod_func, shl_func, shr_func, band_func, bor_func,
        bxor_func, less_func, lesseq_func, greater_func, greatereq_func, equals_func, noteq_func;
