...
kefir_result_t kefir_int_test(struct kefir_mem *mem) {
    ...
    kefir_irbuilder_block_append2(mem, &getarg->body, KEFIR_IROPCODE_VARARG_GET, doubletype_id, 0);   // 9: [C, A]
    ...
    kefir_irbuilder_block_append2(mem, &getarg->body, KEFIR_IROPCODE_VARARG_GET, doubletype_id, 0);   // 16: [0, V*, A]
