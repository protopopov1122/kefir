...
kefir_result_t kefir_int_test(struct kefir_mem *mem) {
    ...
    REQUIRE_OK(kefir_irbuilder_type_append_v(mem, type1, KEFIR_IR_TYPE_SHORT, 0, 0));
    REQUIRE_OK(kefir_irbuilder_type_append_v(mem, type1, KEFIR_IR_TYPE_FLOAT64, 0, 0));
    ...
    kefir_irbuilder_block_appendu32(mem, &func->body, KEFIR_IROPCODE_EXTRACTBITS, 0, 4);
    kefir_irbuilder_block_appendi64(mem, &func->body, KEFIR_IROPCODE_PICK, 1);
    kefir_irbuilder_block_appendu32(mem, &func->body, KEFIR_IROPCODE_EXTRACTBITS, 4, 4);
    kefir_irbuilder_block_appendi64(mem, &func->body, KEFIR_IROPCODE_PICK, 2);
    kefir_irbuilder_block_appendu32(mem, &func->body, KEFIR_IROPCODE_EXTRACTBITS, 8, 4);
    kefir_irbuilder_block_appendi64(mem, &func->body, KEFIR_IROPCODE_PICK, 3);
    kefir_irbuilder_block_appendu32(mem, &func->body, KEFIR_IROPCODE_EXTRACTBITS, 12, 4);
    kefir_irbuilder_block_appendi64(mem, &func->body, KEFIR_IROPCODE_PICK, 4);
    kefir_irbuilder_block_appendu32(mem, &func->body, KEFIR_IROPCODE_EXTRACTBITS, 16, 4);
    kefir_irbuilder_block_appendi64(mem, &func->body, KEFIR_IROPCODE_PICK, 5);
    kefir_irbuilder_block_appendu32(mem, &func->body, KEFIR_IROPCODE_EXTRACTBITS, 20, 4);
    kefir_irbuilder_block_appendi64(mem, &func->body, KEFIR_IROPCODE_PICK, 6);
    kefir_irbuilder_block_appendu32(mem, &func->body, KEFIR_IROPCODE_EXTRACTBITS, 24, 4);
    kefir_irbuilder_block_appendi64(mem, &func->body, KEFIR_IROPCODE_PICK, 7);
    kefir_irbuilder_block_appendu32(mem, &func->body, KEFIR_IROPCODE_EXTRACTBITS, 28, 4);
