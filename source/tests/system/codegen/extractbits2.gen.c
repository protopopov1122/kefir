...
kefir_result_t kefir_int_test(struct kefir_mem *mem) {
    ...
    struct kefir_ir_function_decl *decl =
        kefir_ir_module_new_function_declaration(mem, &module, "extractbits", decl_params, false, decl_result);
    ...
    kefir_irbuilder_block_appendu32(mem, &func->body, KEFIR_IROPCODE_EXTSBITS, 0, 4);
    kefir_irbuilder_block_appendi64(mem, &func->body, KEFIR_IROPCODE_PICK, 1);
    kefir_irbuilder_block_appendu32(mem, &func->body, KEFIR_IROPCODE_EXTSBITS, 4, 4);
    kefir_irbuilder_block_appendi64(mem, &func->body, KEFIR_IROPCODE_PICK, 2);
    kefir_irbuilder_block_appendu32(mem, &func->body, KEFIR_IROPCODE_EXTSBITS, 8, 4);
    kefir_irbuilder_block_appendi64(mem, &func->body, KEFIR_IROPCODE_PICK, 3);
    kefir_irbuilder_block_appendu32(mem, &func->body, KEFIR_IROPCODE_EXTSBITS, 12, 4);
    kefir_irbuilder_block_appendi64(mem, &func->body, KEFIR_IROPCODE_PICK, 4);
    kefir_irbuilder_block_appendu32(mem, &func->body, KEFIR_IROPCODE_EXTSBITS, 16, 4);
    kefir_irbuilder_block_appendi64(mem, &func->body, KEFIR_IROPCODE_PICK, 5);
    kefir_irbuilder_block_appendu32(mem, &func->body, KEFIR_IROPCODE_EXTSBITS, 20, 4);
    kefir_irbuilder_block_appendi64(mem, &func->body, KEFIR_IROPCODE_PICK, 6);
    kefir_irbuilder_block_appendu32(mem, &func->body, KEFIR_IROPCODE_EXTSBITS, 24, 4);
    kefir_irbuilder_block_appendi64(mem, &func->body, KEFIR_IROPCODE_PICK, 7);
    kefir_irbuilder_block_appendu32(mem, &func->body, KEFIR_IROPCODE_EXTSBITS, 28, 4);
