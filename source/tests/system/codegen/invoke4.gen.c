...
kefir_result_t kefir_int_test(struct kefir_mem *mem) {
    ...
    struct kefir_ir_type *proxyadd_decl_params = kefir_ir_module_new_type(mem, &module, 3, &func_params),
                         *proxyadd_decl_result = kefir_ir_module_new_type(mem, &module, 3, &func_returns);
    ...
    REQUIRE_OK(kefir_ir_module_declare_external(mem, &module, addstruct_decl->name, KEFIR_IR_IDENTIFIER_GLOBAL));
