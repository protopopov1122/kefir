...
kefir_result_t kefir_int_test(struct kefir_mem *mem) {
    ...
    kefir_ir_type_append_v(fequals->declaration->params, KEFIR_IR_TYPE_FLOAT32, 0, 0);
    kefir_ir_type_append_v(fequals->declaration->params, KEFIR_IR_TYPE_FLOAT32, 0, 0);
    kefir_ir_type_append_v(fequals->declaration->result, KEFIR_IR_TYPE_BOOL, 0, 3);
    kefir_irblock_append(&fequals->body, KEFIR_IROPCODE_F32EQUALS, 0);
    ...
    kefir_ir_type_append_v(fgreater->declaration->params, KEFIR_IR_TYPE_FLOAT32, 0, 0);
    kefir_ir_type_append_v(fgreater->declaration->params, KEFIR_IR_TYPE_FLOAT32, 0, 0);
    kefir_ir_type_append_v(fgreater->declaration->result, KEFIR_IR_TYPE_BOOL, 0, 3);
    kefir_irblock_append(&fgreater->body, KEFIR_IROPCODE_F32GREATER, 0);
    ...
    kefir_ir_type_append_v(flesser->declaration->params, KEFIR_IR_TYPE_FLOAT32, 0, 0);
    kefir_ir_type_append_v(flesser->declaration->params, KEFIR_IR_TYPE_FLOAT32, 0, 0);
    kefir_ir_type_append_v(flesser->declaration->result, KEFIR_IR_TYPE_BOOL, 0, 3);
    kefir_irblock_append(&flesser->body, KEFIR_IROPCODE_F32LESSER, 0);
    ...
    kefir_ir_type_append_v(dequals->declaration->params, KEFIR_IR_TYPE_FLOAT64, 0, 0);
    kefir_ir_type_append_v(dequals->declaration->params, KEFIR_IR_TYPE_FLOAT64, 0, 0);
    kefir_ir_type_append_v(dequals->declaration->result, KEFIR_IR_TYPE_BOOL, 0, 3);
    kefir_irblock_append(&dequals->body, KEFIR_IROPCODE_F64EQUALS, 0);
    ...
    kefir_ir_type_append_v(dgreater->declaration->params, KEFIR_IR_TYPE_FLOAT64, 0, 0);
    kefir_ir_type_append_v(dgreater->declaration->params, KEFIR_IR_TYPE_FLOAT64, 0, 0);
    kefir_ir_type_append_v(dgreater->declaration->result, KEFIR_IR_TYPE_BOOL, 0, 3);
    kefir_irblock_append(&dgreater->body, KEFIR_IROPCODE_F64GREATER, 0);
    ...
    kefir_ir_type_append_v(dlesser->declaration->params, KEFIR_IR_TYPE_FLOAT64, 0, 0);
    kefir_ir_type_append_v(dlesser->declaration->params, KEFIR_IR_TYPE_FLOAT64, 0, 0);
    kefir_ir_type_append_v(dlesser->declaration->result, KEFIR_IR_TYPE_BOOL, 0, 3);
    kefir_irblock_append(&dlesser->body, KEFIR_IROPCODE_F64LESSER, 0);
