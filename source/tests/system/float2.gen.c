...
kefir_result_t kefir_int_test(struct kefir_mem *mem) {
    ...
    kefir_irbuilder_block_appendf(mem, &func->body, KEFIR_IROPCODE_PUSHF64, 3.14159);         // [V, R*, R1*, V, PI]
    kefir_irbuilder_block_appendf(mem, &func->body, KEFIR_IROPCODE_PUSHF64, 2.0);             // [V, R*, R1*, V, PI, 2f]
    kefir_irbuilder_block_append(mem, &func->body, KEFIR_IROPCODE_F64MUL, 0);                 // [V, R*, R1*, V, 2*PI]
    kefir_irbuilder_block_append(mem, &func->body, KEFIR_IROPCODE_F64MUL, 0);                 // [V, R*, R1*, 2*PI*V]
    kefir_irbuilder_block_append(mem, &func->body, KEFIR_IROPCODE_XCHG, 1);                   // [V, R*, 2*PI*V, R1*]
    kefir_irbuilder_block_append(mem, &func->body, KEFIR_IROPCODE_STORE64, 0);                // [V, R*]
    kefir_irbuilder_block_append(mem, &func->body, KEFIR_IROPCODE_PICK, 0);                   // [V, R*, R*]
    ...
    kefir_irbuilder_block_append(mem, &func->body, KEFIR_IROPCODE_F64MUL, 0);                 // [V, R*, R2*, V*V]
    kefir_irbuilder_block_appendf(mem, &func->body, KEFIR_IROPCODE_PUSHF64, 3.14159);         // [V, R*, R2*, V*V, PI]
    kefir_irbuilder_block_append(mem, &func->body, KEFIR_IROPCODE_F64MUL, 0);                 // [V, R*, R2*, V*V*PI]
    kefir_irbuilder_block_appendf(mem, &func->body, KEFIR_IROPCODE_PUSHF64, 2.0);             // [V, R*, R2*, V*V*PI, 2f]
    kefir_irbuilder_block_append(mem, &func->body, KEFIR_IROPCODE_F64DIV, 0);                 // [V, R*, R2*, V*V*PI/2]
    ...
    kefir_irbuilder_block_append(mem, &func->body, KEFIR_IROPCODE_PICK, 2);                   // [V, R*, R2*, V]
    kefir_irbuilder_block_appendf(mem, &func->body, KEFIR_IROPCODE_PUSHF64, 0.0);             // [V, R*, R2*, V, 0f]
    kefir_irbuilder_block_append(mem, &func->body, KEFIR_IROPCODE_XCHG, 1);                   // [V, R*, R2*, 0f, V]
    kefir_irbuilder_block_append(mem, &func->body, KEFIR_IROPCODE_F64SUB, 0);                 // [V, R*, R2*, -V]
