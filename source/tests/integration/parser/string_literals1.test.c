...
kefir_result_t kefir_int_test(struct kefir_mem *mem) {
    ...
    const char Literal1[] = "Literal1 string literal. It's a normal one";
    ...
    REQUIRE_OK(kefir_token_new_string_literal_unicode16(mem, Literal3, sizeof(Literal3) / sizeof(Literal3[0]),
                                                        &TOKENS[counter++]));
    REQUIRE_OK(kefir_token_new_string_literal_unicode32(mem, Literal4, sizeof(Literal4) / sizeof(Literal4[0]),
                                                        &TOKENS[counter++]));
    REQUIRE_OK(
