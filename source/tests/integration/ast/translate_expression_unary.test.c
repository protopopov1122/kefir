...
kefir_result_t kefir_int_test(struct kefir_mem *mem) {
    ...
    REQUIRE_OK(kefir_ast_global_context_define_external(mem, &global_context, "Y", type_B, NULL, NULL, NULL, NULL));
    REQUIRE_OK(kefir_ast_global_context_define_external(mem, &global_context, "Z", type_C, NULL, NULL, NULL, NULL));
    REQUIRE_OK(kefir_ast_global_context_define_external(mem, &global_context, "W", type_D, NULL, NULL, NULL, NULL));
