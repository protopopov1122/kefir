...
kefir_result_t kefir_int_test(struct kefir_mem *mem) {
    ...
    FUNC("add_integral", {
        BINARY_NODE(KEFIR_AST_OPERATION_ADD, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_char(mem, 'x')),
                    KEFIR_AST_NODE_BASE(kefir_ast_new_constant_char(mem, 'Y')));
        BINARY_NODE(KEFIR_AST_OPERATION_ADD, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int(mem, 100)),
                    KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int(mem, -99)));
        BINARY_NODE(KEFIR_AST_OPERATION_ADD, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int(mem, -1)),
                    KEFIR_AST_NODE_BASE(kefir_ast_new_constant_uint(mem, 1001)));
        BINARY_NODE(KEFIR_AST_OPERATION_ADD, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_long_long(mem, 100500)),
    ...
    FUNC("add_floating_point", {
        ...
        BINARY_NODE(KEFIR_AST_OPERATION_ADD, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_float(mem, 0.763f)),
                    KEFIR_AST_NODE_BASE(kefir_ast_new_constant_char(mem, '\0')));
        BINARY_NODE(KEFIR_AST_OPERATION_ADD, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_float(mem, 3.141f)),
                    KEFIR_AST_NODE_BASE(kefir_ast_new_constant_float(mem, 2.718f)));
        BINARY_NODE(KEFIR_AST_OPERATION_ADD, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_double(mem, 100.0001)),
                    KEFIR_AST_NODE_BASE(kefir_ast_new_constant_long(mem, 2)));
        BINARY_NODE(KEFIR_AST_OPERATION_ADD, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_float(mem, 0.0001f)),
                    KEFIR_AST_NODE_BASE(kefir_ast_new_constant_double(mem, 0.02)));
        BINARY_NODE(KEFIR_AST_OPERATION_ADD, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_double(mem, 6492.00054)),
    ...
    struct kefir_ast_type_name *type_name3 = kefir_ast_new_type_name(
        mem, kefir_ast_declarator_array(
                 mem, KEFIR_AST_DECLARATOR_ARRAY_BOUNDED, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int(mem, 4)),
    ...
    FUNC("add_pointer_int", {
        ...
        BINARY_NODE(KEFIR_AST_OPERATION_ADD, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int(mem, 100)),
                    KEFIR_AST_NODE_BASE(kefir_ast_new_cast_operator(
                        mem, type_name3, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int(mem, 101)))));

        BINARY_NODE(KEFIR_AST_OPERATION_ADD,
                    KEFIR_AST_NODE_BASE(kefir_ast_new_cast_operator(
                        mem, type_name4, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int(mem, -1)))),
                    KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int(mem, 0)));
    });

    FUNC("sub_integral", {
        BINARY_NODE(KEFIR_AST_OPERATION_SUBTRACT, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_char(mem, 'c')),
                    KEFIR_AST_NODE_BASE(kefir_ast_new_constant_char(mem, 'a')));
        BINARY_NODE(KEFIR_AST_OPERATION_SUBTRACT, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_uint(mem, 100)),
                    KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int(mem, -50)));
        BINARY_NODE(KEFIR_AST_OPERATION_SUBTRACT, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_long_long(mem, 123456)),
                    KEFIR_AST_NODE_BASE(kefir_ast_new_constant_long(mem, 98765)));
        BINARY_NODE(KEFIR_AST_OPERATION_SUBTRACT, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_char(mem, '\n')),
                    KEFIR_AST_NODE_BASE(kefir_ast_new_constant_ulong(mem, 1)));
    });

    FUNC("sub_floating_point", {
        BINARY_NODE(KEFIR_AST_OPERATION_SUBTRACT, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int(mem, 69)),
                    KEFIR_AST_NODE_BASE(kefir_ast_new_constant_float(mem, 5.0045f)));
        BINARY_NODE(KEFIR_AST_OPERATION_SUBTRACT, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_float(mem, 1.0f)),
                    KEFIR_AST_NODE_BASE(kefir_ast_new_constant_char(mem, '\\')));
        BINARY_NODE(KEFIR_AST_OPERATION_SUBTRACT, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_float(mem, 5.11f)),
                    KEFIR_AST_NODE_BASE(kefir_ast_new_constant_float(mem, 2.03f)));
        BINARY_NODE(KEFIR_AST_OPERATION_SUBTRACT, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_long(mem, 2048)),
                    KEFIR_AST_NODE_BASE(kefir_ast_new_constant_double(mem, 1e5)));
        BINARY_NODE(KEFIR_AST_OPERATION_SUBTRACT, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_float(mem, 0.0001)),
                    KEFIR_AST_NODE_BASE(kefir_ast_new_constant_double(mem, 0.00002)));
        BINARY_NODE(KEFIR_AST_OPERATION_SUBTRACT, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_double(mem, 6.01)),
                    KEFIR_AST_NODE_BASE(kefir_ast_new_constant_float(mem, 0.3f)));
        BINARY_NODE(KEFIR_AST_OPERATION_SUBTRACT, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_double(mem, 0.005)),
    ...
    struct kefir_ast_type_name *type_name9 = kefir_ast_new_type_name(
        mem, kefir_ast_declarator_pointer(mem, kefir_ast_declarator_identifier(mem, NULL, NULL)));
    ...
    FUNC("sub_pointers", {
        BINARY_NODE(
            ...
            KEFIR_AST_NODE_BASE(kefir_ast_new_cast_operator(
                mem, (struct kefir_ast_type_name *) KEFIR_AST_NODE_CLONE(mem, KEFIR_AST_NODE_BASE(type_name5))->self,
        ...
        BINARY_NODE(
            KEFIR_AST_OPERATION_SUBTRACT,
            KEFIR_AST_NODE_BASE(kefir_ast_new_cast_operator(
                mem, (struct kefir_ast_type_name *) KEFIR_AST_NODE_CLONE(mem, KEFIR_AST_NODE_BASE(type_name6))->self,
        ...
        BINARY_NODE(
            KEFIR_AST_OPERATION_SUBTRACT,
            KEFIR_AST_NODE_BASE(kefir_ast_new_cast_operator(
                mem, (struct kefir_ast_type_name *) KEFIR_AST_NODE_CLONE(mem, KEFIR_AST_NODE_BASE(type_name7))->self,
        ...
        BINARY_NODE(
            KEFIR_AST_OPERATION_SUBTRACT,
            KEFIR_AST_NODE_BASE(kefir_ast_new_cast_operator(
                mem, (struct kefir_ast_type_name *) KEFIR_AST_NODE_CLONE(mem, KEFIR_AST_NODE_BASE(type_name8))->self,
    ...
    FUNC("sub_pointer_integer", {
        BINARY_NODE(KEFIR_AST_OPERATION_SUBTRACT,
                    KEFIR_AST_NODE_BASE(kefir_ast_new_cast_operator(
                        mem, type_name5, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int(mem, 100)))),
                    KEFIR_AST_NODE_BASE(kefir_ast_new_constant_long(mem, 16)));
        BINARY_NODE(KEFIR_AST_OPERATION_SUBTRACT,
                    KEFIR_AST_NODE_BASE(kefir_ast_new_cast_operator(
                        mem, type_name6, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int(mem, 200)))),
                    KEFIR_AST_NODE_BASE(kefir_ast_new_constant_char(mem, '\t')));
        BINARY_NODE(KEFIR_AST_OPERATION_SUBTRACT,
                    KEFIR_AST_NODE_BASE(kefir_ast_new_cast_operator(
                        mem, type_name9, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int(mem, 2)))),
                    KEFIR_AST_NODE_BASE(kefir_ast_new_constant_bool(mem, true)));
        BINARY_NODE(KEFIR_AST_OPERATION_SUBTRACT,
                    KEFIR_AST_NODE_BASE(kefir_ast_new_cast_operator(
                        mem, type_name8, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int(mem, 42)))),
