...
kefir_result_t kefir_int_test(struct kefir_mem *mem) {
    ...
    REQUIRE_OK(kefir_ast_struct_type_field(mem, &symbols, struct_type1, "y", kefir_ast_type_array(mem, &type_bundle,
        kefir_ast_type_char(), kefir_ast_constant_expression_integer(mem, 1), NULL), NULL));
    REQUIRE_OK(kefir_ast_struct_type_field(mem, &symbols, struct_type1, "z", kefir_ast_type_unbounded_array(mem, &type_bundle,
    ...
    REQUIRE_OK(kefir_ast_struct_type_field(mem, &symbols, struct_type2, "z", kefir_ast_type_unbounded_array(mem, &type_bundle,
    ...
    REQUIRE_OK(kefir_ast_struct_type_field(mem, &symbols, struct_type3, "internal2", kefir_ast_type_unbounded_array(mem, &type_bundle,
    ...
    REQUIRE_OK(kefir_ast_struct_type_field(mem, &symbols, struct_type4, "outer2", kefir_ast_type_unbounded_array(mem, &type_bundle,
        kefir_ast_type_signed_char(), NULL), NULL));
