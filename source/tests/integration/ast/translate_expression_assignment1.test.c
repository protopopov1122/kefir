...
kefir_result_t kefir_int_test(struct kefir_mem *mem) {
    ...
    REQUIRE_OK(kefir_ast_local_context_declare_external(mem, &local_context,
        "bool", kefir_ast_type_bool(), NULL));
    REQUIRE_OK(kefir_ast_local_context_declare_external(mem, &local_context,
        "char", kefir_ast_type_char(), NULL));
    REQUIRE_OK(kefir_ast_local_context_declare_external(mem, &local_context,
        "uchar", kefir_ast_type_unsigned_char(), NULL));
    REQUIRE_OK(kefir_ast_local_context_declare_external(mem, &local_context,
        "schar", kefir_ast_type_signed_char(), NULL));
    REQUIRE_OK(kefir_ast_local_context_declare_external(mem, &local_context,
        "ushort", kefir_ast_type_unsigned_short(), NULL));
    REQUIRE_OK(kefir_ast_local_context_declare_external(mem, &local_context,
        "sshort", kefir_ast_type_signed_short(), NULL));
    REQUIRE_OK(kefir_ast_local_context_declare_external(mem, &local_context,
        "uint", kefir_ast_type_unsigned_int(), NULL));
    REQUIRE_OK(kefir_ast_local_context_declare_external(mem, &local_context,
        "sint", kefir_ast_type_signed_int(), NULL));
    REQUIRE_OK(kefir_ast_local_context_declare_external(mem, &local_context,
        "float", kefir_ast_type_float(), NULL));
    REQUIRE_OK(kefir_ast_local_context_declare_external(mem, &local_context,
        "ulong", kefir_ast_type_unsigned_long(), NULL));
    REQUIRE_OK(kefir_ast_local_context_declare_external(mem, &local_context,
        "slong", kefir_ast_type_signed_long(), NULL));
    REQUIRE_OK(kefir_ast_local_context_declare_external(mem, &local_context,
        "ullong", kefir_ast_type_unsigned_long_long(), NULL));
    REQUIRE_OK(kefir_ast_local_context_declare_external(mem, &local_context,
        "sllong", kefir_ast_type_signed_long_long(), NULL));
    REQUIRE_OK(kefir_ast_local_context_declare_external(mem, &local_context,
