...
kefir_result_t kefir_int_test(struct kefir_mem *mem) {
    ...
    struct kefir_ir_function_decl *func1_decl =
        kefir_ir_module_new_function_declaration(mem, &module, "func1", NULL, func1_decl_params, false, func1_decl_result);
    ...
    struct kefir_ir_function_decl *func2_decl =
        kefir_ir_module_new_function_declaration(mem, &module,
            kefir_ir_module_symbol(mem, &module, "func2", &func2_id), NULL, func2_decl_params, false, func2_decl_result);
    ...
    struct kefir_ir_function_decl *func3_decl =
        kefir_ir_module_new_function_declaration(mem, &module,
            kefir_ir_module_symbol(mem, &module, "func3", &func3_id), NULL, func3_decl_params, false, func3_decl_result);
