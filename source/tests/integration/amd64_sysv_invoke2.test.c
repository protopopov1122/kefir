...
kefir_result_t kefir_int_test(struct kefir_mem *mem) {
    ...
    struct kefir_ir_function *func1 = kefir_ir_module_new_function(mem, &module, func1_decl->identifier, 1024);
    ...
    struct kefir_ir_type *func2_decl_params = kefir_ir_module_new_type(mem, &module, 3, NULL),
                       *func2_decl_result = kefir_ir_module_new_type(mem, &module, 0, NULL);
