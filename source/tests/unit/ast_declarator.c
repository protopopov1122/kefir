...
const char *IDENTS[] = {"a", "abc", "test_123_test_56", "quite_long_identifier_here", "reallyReallyLongIdentifierHere"};
...
ASSERT_OK(kefir_ast_type_qualifier_list_remove(&kft_mem, &decl->pointer.type_qualifiers,
                                               kefir_ast_type_qualifier_list_iter(&decl->pointer.type_qualifiers,
                                                                                  NULL)));
