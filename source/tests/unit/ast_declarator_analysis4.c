...
ASSERT_OK(kefir_ast_struct_type_field(&kft_mem, context->symbols, struct_type1, "field1", kefir_ast_type_signed_int(),
                                      NULL));
ASSERT_OK(kefir_ast_struct_type_field(&kft_mem, context->symbols, struct_type1, "field2", kefir_ast_type_float(),
                                      NULL));
...
ASSERT_IDENTIFIER_TYPE(&kft_mem, context,
                       ...
                       kefir_ast_type_specifier_struct(&kft_mem,
                                                       kefir_ast_structure_specifier_init(&kft_mem, context->symbols,
                                                                                          "structure1", false)));
...
ASSERT_IDENTIFIER_TYPE(&kft_mem, context, type1, KEFIR_AST_SCOPE_IDENTIFIER_STORAGE_UNKNOWN,
                       KEFIR_AST_FUNCTION_SPECIFIER_NONE, 0, 1, kefir_ast_type_specifier_struct(&kft_mem, specifier1));
...
ASSERT_OK(kefir_ast_struct_type_field(&kft_mem, context->symbols, union_type1, "field1", kefir_ast_type_signed_int(),
                                      NULL));
ASSERT_OK(kefir_ast_struct_type_field(&kft_mem, context->symbols, union_type1, "field2", kefir_ast_type_float(), NULL));
...
const struct kefir_ast_type *type2 = kefir_ast_type_structure(&kft_mem, context->type_bundle, "struct1", &struct_type2);
...
ASSERT_IDENTIFIER_TYPE(&kft_mem, context, type1, KEFIR_AST_SCOPE_IDENTIFIER_STORAGE_UNKNOWN,
                       KEFIR_AST_FUNCTION_SPECIFIER_NONE, 0, 1, kefir_ast_type_specifier_union(&kft_mem, specifier1));
...
struct kefir_ast_enum_specifier *specifier2 = kefir_ast_enum_specifier_init(&kft_mem, context->symbols, "enum2", true);
...
ASSERT_IDENTIFIER_TYPE(&kft_mem, context,
                       ...
                       KEFIR_AST_SCOPE_IDENTIFIER_STORAGE_UNKNOWN, KEFIR_AST_FUNCTION_SPECIFIER_NONE, 0, 1,
                       kefir_ast_type_specifier_enum(&kft_mem, kefir_ast_enum_specifier_init(&kft_mem, context->symbols,
                                                                                             "enum1", false)));
...
ASSERT_IDENTIFIER_TYPE(&kft_mem, context, type1, KEFIR_AST_SCOPE_IDENTIFIER_STORAGE_UNKNOWN,
                       KEFIR_AST_FUNCTION_SPECIFIER_NONE, 0, 1, kefir_ast_type_specifier_enum(&kft_mem, specifier1));

ASSERT_IDENTIFIER_TYPE(&kft_mem, context, type2, KEFIR_AST_SCOPE_IDENTIFIER_STORAGE_UNKNOWN,
                       KEFIR_AST_FUNCTION_SPECIFIER_NONE, 0, 1, kefir_ast_type_specifier_enum(&kft_mem, specifier2));
...
ASSERT_IDENTIFIER_TYPE(
    ...
    kefir_ast_type_specifier_typedef(&kft_mem, context->symbols, "someint_t"), kefir_ast_type_qualifier_const(&kft_mem),
...
ASSERT_OK(kefir_ast_struct_type_field(&kft_mem, context->symbols, struct_type1, "floatingPoint", kefir_ast_type_float(),
                                      NULL));
