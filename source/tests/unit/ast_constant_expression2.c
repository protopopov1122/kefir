...
for (kefir_size_t i = 0; i < 100; i++) {
    ...
    ASSERT_INTPTR_CONST_EXPR(
        &kft_mem, context,
        kefir_ast_new_cast_operator(&kft_mem, type_name1, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int(&kft_mem, i))),
        i, 0);
    ...
    ASSERT_INTPTR_CONST_EXPR(
        &kft_mem, context,
        kefir_ast_new_cast_operator(&kft_mem, type_name2, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int(&kft_mem, i))),
        i, 0);
    ...
    ASSERT_INTPTR_CONST_EXPR(
        &kft_mem, context,
        kefir_ast_new_cast_operator(&kft_mem, type_name3, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int(&kft_mem, i))),
        i, 0);
    ...
    ASSERT_INTPTR_CONST_EXPR(
        &kft_mem, context,
        kefir_ast_new_cast_operator(&kft_mem, type_name4, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int(&kft_mem, i))),
        i, 0);
}
...
ASSERT_INTEGER_CONST_EXPR(
    ...
    kefir_ast_new_conditional_operator(&kft_mem,
                                       KEFIR_AST_NODE_BASE(kefir_ast_new_unary_operation(
                                           ...
                                           KEFIR_AST_NODE_BASE(kefir_ast_new_identifier(&kft_mem, context->symbols,
                                                                                        "variableX")))),
                                       KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int(&kft_mem, 1)),
                                       KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int(&kft_mem, 2))),
    1);
