...
ASSERT_OK(append_specifiers(&kft_mem, &type_name15->type_decl.specifiers, 1, kefir_ast_type_specifier_void(&kft_mem)));
...
ASSERT_OK(append_specifiers(&kft_mem, &type_name16->type_decl.specifiers, 1, kefir_ast_type_specifier_char(&kft_mem)));
...
ASSERT_INTEGER_CONST_EXPR(&kft_mem, context,
                          kefir_ast_new_unary_operation(&kft_mem, KEFIR_AST_OPERATION_SIZEOF,
                                                        KEFIR_AST_NODE_BASE(kefir_ast_new_constant_bool(&kft_mem,
                                                                                                        true))),
                          1);
...
ASSERT_INTEGER_CONST_EXPR(&kft_mem, context,
                          kefir_ast_new_unary_operation(&kft_mem, KEFIR_AST_OPERATION_SIZEOF,
                                                        KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int(&kft_mem,
                                                                                                       -100))),
                          4);

ASSERT_INTEGER_CONST_EXPR(&kft_mem, context,
                          kefir_ast_new_unary_operation(&kft_mem, KEFIR_AST_OPERATION_SIZEOF,
                                                        KEFIR_AST_NODE_BASE(kefir_ast_new_constant_uint(&kft_mem,
                                                                                                        200))),
                          4);

ASSERT_INTEGER_CONST_EXPR(&kft_mem, context,
                          kefir_ast_new_unary_operation(&kft_mem, KEFIR_AST_OPERATION_SIZEOF,
                                                        KEFIR_AST_NODE_BASE(kefir_ast_new_constant_long(&kft_mem,
                                                                                                        -100500))),
                          8);

ASSERT_INTEGER_CONST_EXPR(&kft_mem, context,
                          kefir_ast_new_unary_operation(&kft_mem, KEFIR_AST_OPERATION_SIZEOF,
                                                        KEFIR_AST_NODE_BASE(kefir_ast_new_constant_ulong(&kft_mem,
                                                                                                         100500))),
                          8);

ASSERT_INTEGER_CONST_EXPR(&kft_mem, context,
                          kefir_ast_new_unary_operation(&kft_mem, KEFIR_AST_OPERATION_SIZEOF,
                                                        KEFIR_AST_NODE_BASE(kefir_ast_new_constant_long_long(&kft_mem,
                                                                                                             -100500))),
                          8);

ASSERT_INTEGER_CONST_EXPR(&kft_mem, context,
                          kefir_ast_new_unary_operation(&kft_mem, KEFIR_AST_OPERATION_SIZEOF,
                                                        KEFIR_AST_NODE_BASE(kefir_ast_new_constant_ulong_long(&kft_mem,
                                                                                                              100500))),
                          8);

ASSERT_INTEGER_CONST_EXPR(&kft_mem, context,
                          kefir_ast_new_unary_operation(&kft_mem, KEFIR_AST_OPERATION_SIZEOF,
                                                        KEFIR_AST_NODE_BASE(kefir_ast_new_constant_float(&kft_mem,
                                                                                                         2.71828f))),
                          4);

ASSERT_INTEGER_CONST_EXPR(&kft_mem, context,
                          kefir_ast_new_unary_operation(&kft_mem, KEFIR_AST_OPERATION_SIZEOF,
                                                        KEFIR_AST_NODE_BASE(kefir_ast_new_constant_double(&kft_mem,
                                                                                                          3.14159))),
                          8);
...
ASSERT_OK(kefir_ast_initializer_list_append(
    ...
    kefir_ast_new_expression_initializer(&kft_mem, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_char(&kft_mem, 'H')))));
...
struct kefir_ast_type_name *type_name15 = kefir_ast_new_type_name(
    &kft_mem, kefir_ast_declarator_pointer(&kft_mem, kefir_ast_declarator_identifier(&kft_mem, NULL, NULL)));
ASSERT_OK(append_specifiers(&kft_mem, &type_name15->type_decl.specifiers, 1, kefir_ast_type_specifier_short(&kft_mem)));
...
ASSERT_OK(kefir_ast_struct_type_field(&kft_mem, context->symbols, struct1, "fieldZ",
...
ASSERT_OK(kefir_ast_global_context_declare_external(&kft_mem, &global_context, "variableX", kefir_ast_type_signed_int(),
                                                    NULL, NULL));
...
ASSERT_INTEGER_CONST_EXPR(&kft_mem, context,
                          kefir_ast_new_unary_operation(&kft_mem, KEFIR_AST_OPERATION_LOGICAL_NEGATE,
                                                        KEFIR_AST_NODE_BASE(kefir_ast_new_unary_operation(
                                                            &kft_mem, KEFIR_AST_OPERATION_ADDRESS,
                                                            KEFIR_AST_NODE_BASE(kefir_ast_new_identifier(
                                                                &kft_mem, context->symbols, "variableX"))))),
                          0);
...
ASSERT_INTEGER_CONST_EXPR(
    ...
    kefir_ast_new_unary_operation(
        ...
        KEFIR_AST_NODE_BASE(kefir_ast_new_cast_operator(
            &kft_mem, (struct kefir_ast_type_name *) KEFIR_AST_NODE_CLONE(&kft_mem, KEFIR_AST_NODE_BASE(type_name1)),
