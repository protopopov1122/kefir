...
ASSERT_OK(kefir_ast_global_context_define_type(&kft_mem, &global_context, "type2", kefir_ast_type_signed_long(), NULL));
...
do {
    ...
    ASSERT_OK(kefir_ast_local_context_define_static(&kft_mem, &context, "type1", kefir_ast_type_unsigned_char(), NULL,
                                                    NULL, NULL));
