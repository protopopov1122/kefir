...
ASSERT_OK(kefir_ast_global_context_declare_external(&kft_mem, &global_context, "x", type1, NULL, NULL));
ASSERT_OK(kefir_ast_global_context_declare_external(&kft_mem, &global_context, "y", kefir_ast_type_unsigned_int(), NULL,
                                                    NULL));
...
ASSERT_CONDITIONAL(&kft_mem, context, KEFIR_AST_NODE_BASE(kefir_ast_new_identifier(&kft_mem, context->symbols, "y")),
                   KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int(&kft_mem, 1)),
...
ASSERT_CONDITIONAL(&kft_mem, context, KEFIR_AST_NODE_BASE(kefir_ast_new_identifier(&kft_mem, context->symbols, "X")),
                   KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int(&kft_mem, 1)),
                   KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int(&kft_mem, 2)), true, {
...
ASSERT_OK(kefir_ast_global_context_declare_external(&kft_mem, &global_context, "x", kefir_ast_type_signed_int(), NULL,
                                                    NULL));
...
ASSERT_CONDITIONAL(
    &kft_mem, context, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_bool(&kft_mem, true)),
    KEFIR_AST_NODE_BASE(kefir_ast_new_cast_operator(
        &kft_mem, (struct kefir_ast_type_name *) KEFIR_AST_NODE_CLONE(&kft_mem, KEFIR_AST_NODE_BASE(type_name1))->self,
...
ASSERT_OK(kefir_ast_struct_type_field(&kft_mem, context->symbols, struct_type3, "z", kefir_ast_type_double(), NULL));
...
ASSERT_OK(kefir_ast_local_context_define_auto(&kft_mem, &local_context, "a1", type1, NULL, NULL, NULL));
ASSERT_OK(kefir_ast_local_context_define_static(&kft_mem, &local_context, "a2", type1, NULL, NULL, NULL));
ASSERT_OK(kefir_ast_local_context_define_auto(&kft_mem, &local_context, "b1", type2, NULL, NULL, NULL));
ASSERT_OK(kefir_ast_local_context_define_static(&kft_mem, &local_context, "b2", type2, NULL, NULL, NULL));
ASSERT_OK(kefir_ast_local_context_define_auto(&kft_mem, &local_context, "c1", type3, NULL, NULL, NULL));
ASSERT_OK(kefir_ast_local_context_define_static(&kft_mem, &local_context, "c2", type3, NULL, NULL, NULL));
ASSERT_OK(kefir_ast_local_context_define_auto(&kft_mem, &local_context, "d1", type4, NULL, NULL, NULL));
ASSERT_OK(kefir_ast_local_context_define_static(&kft_mem, &local_context, "d2", type4, NULL, NULL, NULL));
...
ASSERT_CONDITIONAL(
    ...
    KEFIR_AST_NODE_BASE(kefir_ast_new_cast_operator(
        ...
        KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int(&kft_mem, 0)))),
    KEFIR_AST_NODE_BASE(kefir_ast_new_cast_operator(
        &kft_mem, (struct kefir_ast_type_name *) KEFIR_AST_NODE_CLONE(&kft_mem, KEFIR_AST_NODE_BASE(type_name2))->self,
        KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int(&kft_mem, 0)))),
...
ASSERT_CONDITIONAL(
    ...
    KEFIR_AST_NODE_BASE(kefir_ast_new_cast_operator(
        ...
        KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int(&kft_mem, 0)))),
    KEFIR_AST_NODE_BASE(kefir_ast_new_cast_operator(
        &kft_mem, (struct kefir_ast_type_name *) KEFIR_AST_NODE_CLONE(&kft_mem, KEFIR_AST_NODE_BASE(type_name3))->self,
        KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int(&kft_mem, 0)))),
...
ASSERT_CONDITIONAL(
    ...
    KEFIR_AST_NODE_BASE(kefir_ast_new_cast_operator(
        ...
        KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int(&kft_mem, 0)))),
    KEFIR_AST_NODE_BASE(kefir_ast_new_cast_operator(
        &kft_mem, (struct kefir_ast_type_name *) KEFIR_AST_NODE_CLONE(&kft_mem, KEFIR_AST_NODE_BASE(type_name4))->self,
        KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int(&kft_mem, 0)))),
    true, { ASSERT(KEFIR_AST_TYPE_SAME(oper->base.properties.type, type_4)); });
...
ASSERT_CONDITIONAL(
    ...
    KEFIR_AST_NODE_BASE(kefir_ast_new_cast_operator(
        ...
        KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int(&kft_mem, 0)))),
    KEFIR_AST_NODE_BASE(kefir_ast_new_cast_operator(
        &kft_mem, (struct kefir_ast_type_name *) KEFIR_AST_NODE_CLONE(&kft_mem, KEFIR_AST_NODE_BASE(type_name5))->self,
        KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int(&kft_mem, 0)))),
...
ASSERT_CONDITIONAL(
    ...
    KEFIR_AST_NODE_BASE(kefir_ast_new_cast_operator(
        ...
        KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int(&kft_mem, 0)))),
    KEFIR_AST_NODE_BASE(kefir_ast_new_cast_operator(
        &kft_mem, (struct kefir_ast_type_name *) KEFIR_AST_NODE_CLONE(&kft_mem, KEFIR_AST_NODE_BASE(type_name6))->self,
        KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int(&kft_mem, 0)))),
...
ASSERT_CONDITIONAL(
    ...
    KEFIR_AST_NODE_BASE(kefir_ast_new_cast_operator(
        ...
        KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int(&kft_mem, 0)))),
    KEFIR_AST_NODE_BASE(kefir_ast_new_cast_operator(
        &kft_mem, (struct kefir_ast_type_name *) KEFIR_AST_NODE_CLONE(&kft_mem, KEFIR_AST_NODE_BASE(type_name7))->self,
        KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int(&kft_mem, 0)))),
...
ASSERT_CONDITIONAL(
    ...
    KEFIR_AST_NODE_BASE(kefir_ast_new_cast_operator(
        ...
        KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int(&kft_mem, 0)))),
    KEFIR_AST_NODE_BASE(kefir_ast_new_cast_operator(
        &kft_mem, (struct kefir_ast_type_name *) KEFIR_AST_NODE_CLONE(&kft_mem, KEFIR_AST_NODE_BASE(type_name8))->self,
        KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int(&kft_mem, 0)))),
    true, { ASSERT(KEFIR_AST_TYPE_SAME(oper->base.properties.type, type_8)); });
