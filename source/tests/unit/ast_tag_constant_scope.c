...
ASSERT_OK(kefir_ast_global_context_define_tag(&kft_mem, &global_context,
                                              kefir_ast_type_incomplete_structure(&kft_mem, &type_bundle, "struct1"),
                                              NULL));
...
ASSERT_OK(kefir_ast_global_context_define_tag(&kft_mem, &global_context,
                                              kefir_ast_type_incomplete_structure(&kft_mem, &type_bundle, "struct2"),
                                              NULL));
...
struct kefir_ast_struct_type *struct_type1 = NULL;
ASSERT_OK(kefir_ast_global_context_define_tag(&kft_mem, &global_context,
                                              kefir_ast_type_structure(&kft_mem, &type_bundle, "type1", &struct_type1),
                                              NULL));
ASSERT_OK(kefir_ast_struct_type_field(&kft_mem, &symbols, struct_type1, "field1", kefir_ast_type_double(), NULL));
ASSERT_OK(kefir_ast_struct_type_field(&kft_mem, &symbols, struct_type1, "field2", kefir_ast_type_unsigned_char(),
                                      NULL));
...
ASSERT_OK(kefir_ast_local_context_define_tag(&kft_mem, &context,
                                             kefir_ast_type_incomplete_union(&kft_mem, &type_bundle, "type1"), NULL));
...
ASSERT_OK(kefir_ast_local_context_define_tag(&kft_mem, &context,
                                             kefir_ast_type_union(&kft_mem, &type_bundle, "type1", &union_type1),
                                             NULL));
...
ASSERT_OK(kefir_ast_local_context_define_tag(
    &kft_mem, &context,
    kefir_ast_type_incomplete_enumeration(&kft_mem, &type_bundle, "type1", type_traits->underlying_enumeration_type),
    NULL));
...
ASSERT_OK(kefir_ast_local_context_define_tag(
    &kft_mem, &context,
    kefir_ast_type_enumeration(&kft_mem, &type_bundle, "type1", type_traits->underlying_enumeration_type, &enum_type1),
    NULL));
...
ASSERT_NOK(kefir_ast_local_context_define_tag(&kft_mem, &context,
                                              kefir_ast_type_incomplete_union(&kft_mem, &type_bundle, "struct1"),
                                              NULL));
ASSERT_NOK(kefir_ast_local_context_define_tag(
    &kft_mem, &context,
    kefir_ast_type_incomplete_enumeration(&kft_mem, &type_bundle, "struct1", type_traits->underlying_enumeration_type),
    NULL));
ASSERT_OK(kefir_ast_local_context_define_tag(&kft_mem, &context,
                                             kefir_ast_type_incomplete_structure(&kft_mem, &type_bundle, "struct1"),
                                             NULL));
...
struct kefir_ast_struct_type *struct_type1 = NULL;
ASSERT_OK(kefir_ast_local_context_define_tag(&kft_mem, &context,
                                             kefir_ast_type_structure(&kft_mem, &type_bundle, "struct1", &struct_type1),
                                             NULL));
ASSERT_OK(kefir_ast_struct_type_field(&kft_mem, &symbols, struct_type1, "field1", kefir_ast_type_double(), NULL));
ASSERT_OK(kefir_ast_struct_type_field(&kft_mem, &symbols, struct_type1, "field2", kefir_ast_type_unsigned_char(),
                                      NULL));
...
do {
    ...
    do {
        ...
        ASSERT_OK(kefir_ast_local_context_define_auto(&kft_mem, &context, "c3", kefir_ast_type_unsigned_char(), NULL,
                                                      NULL, NULL));
