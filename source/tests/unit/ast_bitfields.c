...
DEFINE_CASE(ast_bitfield_translator1, "AST translator - bitfields #1")
    ...
    ASSERT_OK(kefir_ast_struct_type_bitfield(&kft_mem, context.context.symbols, struct_type1,
        NULL, kefir_ast_type_char(), NULL, kefir_ast_constant_expression_integer(&kft_mem, 0)));
    ASSERT_OK(kefir_ast_struct_type_bitfield(&kft_mem, context.context.symbols, struct_type1,
        "field12", kefir_ast_type_char(), NULL, kefir_ast_constant_expression_integer(&kft_mem, 1)));
...
#define ASSERT_MEMBER(_id, _pos, _typecode, _alignment, _width, _offset) \
    ...
    ASSERT_MEMBER("field1", 1, KEFIR_IR_TYPE_INT, 0, 2, 0);
    ASSERT_MEMBER("field2", 1, KEFIR_IR_TYPE_INT, 0, 3, 2);
    ASSERT_MEMBER("field3", 1, KEFIR_IR_TYPE_INT, 0, 10, 5);
    ASSERT_MEMBER("field4", 1, KEFIR_IR_TYPE_INT, 0, 1, 15);
    ASSERT_MEMBER("field5", 1, KEFIR_IR_TYPE_INT, 0, 8, 16);
    ASSERT_MEMBER("field6", 2, KEFIR_IR_TYPE_INT, 0, 10, 0);
    ASSERT_MEMBER("field7", 2, KEFIR_IR_TYPE_INT, 0, 22, 10);
    ASSERT_MEMBER("field8", 3, KEFIR_IR_TYPE_INT, 0, 32, 0);
    ASSERT_MEMBER("field9", 4, KEFIR_IR_TYPE_CHAR, 0, 1, 0);
    ASSERT_MEMBER("field10", 4, KEFIR_IR_TYPE_CHAR, 0, 2, 2);
    ASSERT_MEMBER("field11", 5, KEFIR_IR_TYPE_CHAR, 0, 1, 0);
    ASSERT_MEMBER("field12", 6, KEFIR_IR_TYPE_CHAR, 0, 1, 0);

#undef ASSERT_MEMBER

    ASSERT(kefir_ir_type_total_length(&ir_type1) == 8);
...
DEFINE_CASE(ast_bitfield_translator2, "AST translator - bitfields #2")
    ...
    ASSERT_OK(kefir_ast_struct_type_bitfield(&kft_mem, context.context.symbols, struct_type1,
        "field3", kefir_ast_type_signed_int(), NULL, kefir_ast_constant_expression_integer(&kft_mem, 11)));
    ASSERT_OK(kefir_ast_struct_type_bitfield(&kft_mem, context.context.symbols, struct_type1,
...
#define ASSERT_MEMBER(_id, _pos, _typecode, _alignment, _width, _offset) \
    ...
    ASSERT_MEMBER("field1", 1, KEFIR_IR_TYPE_INT, 0, 5, 0);
    ASSERT_MEMBER("field2", 1, KEFIR_IR_TYPE_INT, 0, 10, 5);
    ASSERT_MEMBER("field3", 1, KEFIR_IR_TYPE_INT, 0, 11, 15);
    ASSERT_MEMBER("field4", 2, KEFIR_IR_TYPE_INT, 0, 8, 0);
    ASSERT_MEMBER("field5", 2, KEFIR_IR_TYPE_INT, 0, 13, 8);
    ASSERT_MEMBER("field6", 3, KEFIR_IR_TYPE_SHORT, 0, 12, 0);
...
#define ASSERT_MEMBER(_id, _pos, _typecode, _alignment, _width, _offset) \
    ...
    ASSERT_MEMBER("field1", 1, KEFIR_IR_TYPE_SHORT, 0, 16, 0);
    ASSERT_MEMBER("field3", 3, KEFIR_IR_TYPE_CHAR, 0, 3, 0);
    ASSERT_MEMBER("field4", 3, KEFIR_IR_TYPE_CHAR, 0, 4, 3);
    ASSERT_MEMBER("field6", 5, KEFIR_IR_TYPE_CHAR, 0, 1, 0);
...
#define ASSERT_MEMBER(_id, _pos, _typecode, _alignment, _width, _offset) \
    ...
    ASSERT_MEMBER("field2", 2, KEFIR_IR_TYPE_CHAR, 0, 3, 0);
    ASSERT_MEMBER("field3", 2, KEFIR_IR_TYPE_CHAR, 0, 2, 3);
    ASSERT_MEMBER("field4", 3, KEFIR_IR_TYPE_SHORT, 0, 8, 0);
    ASSERT_MEMBER("field5", 3, KEFIR_IR_TYPE_SHORT, 0, 6, 8);
    ASSERT_MEMBER("field6", 4, KEFIR_IR_TYPE_INT, 0, 3, 0);
    ASSERT_MEMBER("field7", 4, KEFIR_IR_TYPE_INT, 0, 1, 3);
    ASSERT_MEMBER("field8", 4, KEFIR_IR_TYPE_INT, 0, 1, 4);
    ASSERT_MEMBER("field9", 4, KEFIR_IR_TYPE_INT, 0, 20, 5);
    ASSERT_MEMBER("field10", 4, KEFIR_IR_TYPE_INT, 0, 2, 25);
