...
ASSERT_OK(kefir_ast_struct_type_bitfield(&kft_mem, context.context.symbols, struct_type1, "field11",
                                         kefir_ast_type_signed_int(), NULL,
                                         kefir_ast_constant_expression_integer(&kft_mem, 1)));
ASSERT_OK(kefir_ast_struct_type_bitfield(&kft_mem, context.context.symbols, struct_type1, NULL, kefir_ast_type_char(),
                                         NULL, kefir_ast_constant_expression_integer(&kft_mem, 0)));
...
ASSERT_OK(kefir_ast_struct_type_field(&kft_mem, context.context.symbols, struct_type1, "field2", kefir_ast_type_char(),
                                      NULL));
ASSERT_OK(kefir_ast_struct_type_bitfield(&kft_mem, context.context.symbols, struct_type1, "field3",
                                         kefir_ast_type_unsigned_char(), NULL,
                                         kefir_ast_constant_expression_integer(&kft_mem, 3)));
...
const struct kefir_ast_type *type1 = kefir_ast_type_union(&kft_mem, context.context.type_bundle, NULL, &union_type1);
