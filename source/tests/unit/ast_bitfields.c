...
#define ASSERT_MEMBER(_id, _pos, _width, _offset) \
    ...
    ASSERT_MEMBER("field3", 1, 16, 15);
    ASSERT_MEMBER("field4", 1, 8, 31);
    ASSERT_MEMBER("field5", 1, 13, 39);
    ASSERT_MEMBER("field6", 1, 12, 52);
...
DEFINE_CASE(ast_bitfield_translator3, "AST translator - bitfields #3")
    ...
    ASSERT_OK(kefir_ast_struct_type_bitfield(&kft_mem, context.context.symbols, struct_type1,
        "field3", kefir_ast_type_unsigned_int(), NULL, kefir_ast_constant_expression_integer(&kft_mem, 7)));
    ASSERT_OK(kefir_ast_struct_type_bitfield(&kft_mem, context.context.symbols, struct_type1,
        "field4", kefir_ast_type_unsigned_char(), NULL, kefir_ast_constant_expression_integer(&kft_mem, 4)));
    ASSERT_OK(kefir_ast_struct_type_field(&kft_mem, context.context.symbols, struct_type1,
...
#define ASSERT_MEMBER(_id, _pos, _width, _offset) \
    ...
    ASSERT_MEMBER("field3", 3, 7, 0);
    ASSERT_MEMBER("field4", 3, 4, 7);
