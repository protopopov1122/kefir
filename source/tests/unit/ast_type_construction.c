...
const struct kefir_ast_type *type1 = kefir_ast_type_enumeration(&kft_mem, context->type_bundle, "enum1",
                                                                type_traits->underlying_enumeration_type, &enum1_type);
ASSERT(type1 != NULL);
...
const struct kefir_ast_type *type2 = kefir_ast_type_incomplete_enumeration(&kft_mem, context->type_bundle, "enum2",
...
ASSERT_OK(kefir_ast_struct_type_bitfield(&kft_mem, &symbols, struct_type2, "field20", kefir_ast_type_unsigned_long(),
...
ASSERT_OK(kefir_ast_type_function_parameter(&kft_mem, &type_bundle, func_type1, "arg1",
                                            kefir_ast_type_unbounded_array(&kft_mem, &type_bundle,
                                                                           kefir_ast_type_unsigned_char(), NULL),
                                            NULL));
ASSERT_OK(kefir_ast_type_function_parameter(&kft_mem, &type_bundle, func_type1, "arg2", kefir_ast_type_float(), NULL));
