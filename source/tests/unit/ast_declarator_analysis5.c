...
DEFINE_CASE(ast_declarator_analysis21, "AST declarator analysis - function declarators #1") {
    ...
    struct kefir_ast_declaration *param1 = kefir_ast_new_declaration(
        &kft_mem, kefir_ast_declarator_identifier(&kft_mem, context->symbols, "param1"), NULL);
    ...
    struct kefir_ast_declaration *param2 = kefir_ast_new_declaration(
        &kft_mem, kefir_ast_declarator_identifier(&kft_mem, context->symbols, "param2"), NULL);
    ...
    struct kefir_ast_declaration *param4 = kefir_ast_new_declaration(
        &kft_mem, kefir_ast_declarator_identifier(&kft_mem, context->symbols, "paramN"), NULL);
