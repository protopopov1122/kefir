...
DEFINE_CASE(ast_ordinary_scope_composite_objects_external_declaration,
    ...
    ASSERT_OK(
        kefir_ast_global_context_declare_external(&kft_mem, &global_context, "array1", array1_type1, NULL, NULL, NULL));
    ...
    ASSERT_OK(
        kefir_ast_global_context_declare_external(&kft_mem, &global_context, "array1", array1_type2, NULL, NULL, NULL));
...
DEFINE_CASE(ast_ordinary_scope_composite_objects_thread_local_external,
    ...
    ASSERT_OK(kefir_ast_global_context_define_external_thread_local(&kft_mem, &global_context, "func1", func1_type1,
                                                                    NULL, NULL, NULL, NULL));
    ...
    ASSERT_OK(kefir_ast_global_context_define_external_thread_local(&kft_mem, &global_context, "func1", func1_type2,
                                                                    NULL, NULL, NULL, NULL));
...
DEFINE_CASE(ast_ordinary_scope_composite_objects_local_external,
    ...
    ASSERT_OK(kefir_ast_type_function_parameter(
        ...
        NULL));
    ASSERT_OK(
        kefir_ast_type_function_parameter(&kft_mem, &global_context.type_bundle, function1, NULL, aux_type, NULL));
    ASSERT_OK(kefir_ast_type_function_parameter(
        &kft_mem, &global_context.type_bundle, function1, NULL,
        kefir_ast_type_unbounded_array(&kft_mem, &global_context.type_bundle, kefir_ast_type_double(), NULL), NULL));
    ...
    ASSERT_OK(kefir_ast_type_function_parameter(
        ...
        NULL));
    ASSERT_OK(
        kefir_ast_type_function_parameter(&kft_mem, &global_context.type_bundle, function2, NULL, aux_type, NULL));
    ASSERT_OK(kefir_ast_type_function_parameter(
        &kft_mem, &global_context.type_bundle, function2, NULL,
        kefir_ast_type_array_static(&kft_mem, &global_context.type_bundle, kefir_ast_type_double(),
                                    kefir_ast_constant_expression_integer(&kft_mem, 100), NULL),
    ...
    ASSERT_OK(kefir_ast_local_context_declare_external(&kft_mem, &context, "func1", func1_type1, NULL, NULL, NULL));

    const struct kefir_ast_scoped_identifier *scoped_id = NULL;
    ASSERT_OK(kefir_ast_local_context_resolve_scoped_ordinary_identifier(&context, "func1", &scoped_id));
    ASSERT(KEFIR_AST_TYPE_SAME(scoped_id->type, func1_type1));

    ASSERT_OK(kefir_ast_local_context_declare_external(&kft_mem, &context, "func1", func1_type2, NULL, NULL, NULL));
...
DEFINE_CASE(ast_ordinary_scope_composite_objects_local_thread_local_external,
    ...
    ASSERT_OK(kefir_ast_local_context_declare_external_thread_local(&kft_mem, &context, "func1", func1_type1, NULL,
                                                                    NULL, NULL));
    ...
    ASSERT_OK(kefir_ast_local_context_declare_external_thread_local(&kft_mem, &context, "func1", func1_type2, NULL,
                                                                    NULL, NULL));
