...
DEFINE_CASE(ast_ordinary_scope_objects1, "AST Declaration scoping - global rules for extern")
    ...
    ASSERT_NOK(kefir_ast_global_context_define_external(&kft_mem, &global_context, "ext_int1", kefir_ast_type_signed_long(), NULL, NULL));
    ...
    ASSERT_NOK(kefir_ast_global_context_define_external_thread_local(&kft_mem, &global_context, "ext_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_OK(kefir_ast_global_context_declare_external(&kft_mem, &global_context, "ext_int1", kefir_ast_type_signed_int(), NULL));
...
DEFINE_CASE(ast_ordinary_scope_objects2, "AST Declaration scoping - global rules for thread_local extern")
    ...
    ASSERT_NOK(kefir_ast_global_context_define_external_thread_local(&kft_mem, &global_context, "ext_int1", kefir_ast_type_signed_long(), NULL, NULL));
    ASSERT_NOK(kefir_ast_global_context_declare_external(&kft_mem, &global_context, "ext_int1", kefir_ast_type_signed_int(), NULL));
    ASSERT_NOK(kefir_ast_global_context_define_external(&kft_mem, &global_context, "ext_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_OK(kefir_ast_global_context_declare_external_thread_local(&kft_mem, &global_context, "ext_int1", kefir_ast_type_signed_int(), NULL));
...
DEFINE_CASE(ast_ordinary_scope_objects3, "AST Declaration scoping - global rules for extern #2")
    ...
    ASSERT_OK(kefir_ast_global_context_define_external(&kft_mem, &global_context, "ext_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_OK(kefir_ast_global_context_declare_external(&kft_mem, &global_context, "ext_int1", kefir_ast_type_signed_int(), NULL));
    ASSERT_OK(kefir_ast_global_context_define_external(&kft_mem, &global_context, "ext_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_NOK(kefir_ast_global_context_declare_external(&kft_mem, &global_context, "ext_int1", kefir_ast_type_signed_long(), NULL));
    ASSERT_NOK(kefir_ast_global_context_define_external(&kft_mem, &global_context, "ext_int1", kefir_ast_type_signed_long(), NULL, NULL));
    ASSERT_NOK(kefir_ast_global_context_declare_external_thread_local(&kft_mem, &global_context, "ext_int1", kefir_ast_type_signed_int(), NULL));
    ASSERT_NOK(kefir_ast_global_context_define_external_thread_local(&kft_mem, &global_context, "ext_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_NOK(kefir_ast_global_context_define_static(&kft_mem, &global_context, "ext_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_NOK(kefir_ast_global_context_define_static_thread_local(&kft_mem, &global_context, "ext_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_OK(kefir_ast_global_context_declare_external(&kft_mem, &global_context, "ext_int1", kefir_ast_type_signed_int(), NULL));
    ASSERT_OK(kefir_ast_global_context_define_external(&kft_mem, &global_context, "ext_int1", kefir_ast_type_signed_int(), NULL, NULL));
...
DEFINE_CASE(ast_ordinary_scope_objects4, "AST Declaration scoping - global rules for thread_local extern #2")
    ...
    ASSERT_OK(kefir_ast_global_context_define_external_thread_local(&kft_mem, &global_context, "ext_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_OK(kefir_ast_global_context_declare_external_thread_local(&kft_mem, &global_context, "ext_int1", kefir_ast_type_signed_int(), NULL));
    ASSERT_OK(kefir_ast_global_context_define_external_thread_local(&kft_mem, &global_context, "ext_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_NOK(kefir_ast_global_context_declare_external_thread_local(&kft_mem, &global_context, "ext_int1", kefir_ast_type_signed_long(), NULL));
    ASSERT_NOK(kefir_ast_global_context_define_external_thread_local(&kft_mem, &global_context, "ext_int1", kefir_ast_type_signed_long(), NULL, NULL));
...
DEFINE_CASE(ast_ordinary_scope_objects5, "AST Declaration scoping - global rules for static")
    ...
    ASSERT_OK(kefir_ast_global_context_define_static(&kft_mem, &global_context, "static_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_OK(kefir_ast_global_context_define_static(&kft_mem, &global_context, "static_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_OK(kefir_ast_global_context_declare_external(&kft_mem, &global_context, "static_int1", kefir_ast_type_signed_int(), NULL));
    ASSERT_OK(kefir_ast_global_context_define_static(&kft_mem, &global_context, "static_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_NOK(kefir_ast_global_context_define_static(&kft_mem, &global_context, "static_int1", kefir_ast_type_signed_long(), NULL, NULL));
    ...
    ASSERT_NOK(kefir_ast_global_context_define_external(&kft_mem, &global_context, "static_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_NOK(kefir_ast_global_context_define_external_thread_local(&kft_mem, &global_context, "static_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_NOK(kefir_ast_global_context_define_static_thread_local(&kft_mem, &global_context, "static_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_OK(kefir_ast_global_context_define_static(&kft_mem, &global_context, "static_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_OK(kefir_ast_global_context_declare_external(&kft_mem, &global_context, "static_int1", kefir_ast_type_signed_int(), NULL));
    ...
    ASSERT_NOK(kefir_ast_global_context_define_static(&kft_mem, &global_context, "static_int2", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_OK(kefir_ast_global_context_define_external(&kft_mem, &global_context, "static_int3", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_NOK(kefir_ast_global_context_define_static(&kft_mem, &global_context, "static_int3", kefir_ast_type_signed_int(), NULL, NULL));
...
DEFINE_CASE(ast_ordinary_scope_objects6, "AST Declaration scoping - global rules for thread_local static")
    ...
    ASSERT_OK(kefir_ast_global_context_define_static_thread_local(&kft_mem, &global_context, "static_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_OK(kefir_ast_global_context_define_static_thread_local(&kft_mem, &global_context, "static_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ...
    ASSERT_OK(kefir_ast_global_context_define_static_thread_local(&kft_mem, &global_context, "static_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_NOK(kefir_ast_global_context_define_static_thread_local(&kft_mem, &global_context, "static_int1", kefir_ast_type_signed_long(), NULL, NULL));
    ...
    ASSERT_NOK(kefir_ast_global_context_define_external(&kft_mem, &global_context, "static_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_NOK(kefir_ast_global_context_define_external_thread_local(&kft_mem, &global_context, "static_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_NOK(kefir_ast_global_context_define_static(&kft_mem, &global_context, "static_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_OK(kefir_ast_global_context_define_static_thread_local(&kft_mem, &global_context, "static_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_OK(kefir_ast_global_context_declare_external_thread_local(&kft_mem, &global_context, "static_int1", kefir_ast_type_signed_int(), NULL));
    ...
    ASSERT_NOK(kefir_ast_global_context_define_static_thread_local(&kft_mem, &global_context, "static_int2", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_OK(kefir_ast_global_context_define_external_thread_local(&kft_mem, &global_context, "static_int3", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_NOK(kefir_ast_global_context_define_static_thread_local(&kft_mem, &global_context, "static_int3", kefir_ast_type_signed_int(), NULL, NULL));
...
DEFINE_CASE(ast_ordinary_scope_objects7, "AST Declaration scoping - local extern")
    ...
    ASSERT_OK(kefir_ast_local_context_declare_external(&kft_mem, &context, "ext_int1", kefir_ast_type_signed_int(), NULL));
    ASSERT_OK(kefir_ast_local_context_declare_external(&kft_mem, &context, "ext_int1", kefir_ast_type_signed_int(), NULL));
    ASSERT_NOK(kefir_ast_local_context_define_static(&kft_mem, &context, "ext_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_NOK(kefir_ast_local_context_define_static_thread_local(&kft_mem, &context, "ext_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_NOK(kefir_ast_local_context_declare_external_thread_local(&kft_mem, &context, "ext_int1", kefir_ast_type_signed_int(), NULL));
    ASSERT_NOK(kefir_ast_local_context_declare_external(&kft_mem, &context, "ext_int1", kefir_ast_type_signed_long(), NULL));
    do {
        ...
        do {
            ASSERT_OK(kefir_ast_local_context_push_block_scope(&kft_mem, &context));
            ASSERT_OK(kefir_ast_local_context_define_static(&kft_mem, &context, "ext_int1", kefir_ast_type_signed_int(), NULL, NULL));
            do {
                ASSERT_OK(kefir_ast_local_context_push_block_scope(&kft_mem, &context));
                ASSERT_OK(kefir_ast_local_context_declare_external(&kft_mem, &context, "ext_int1", kefir_ast_type_signed_int(), NULL));
                ASSERT_NOK(kefir_ast_local_context_declare_external_thread_local(&kft_mem, &context, "ext_int1", kefir_ast_type_signed_int(), NULL));
...
DEFINE_CASE(ast_ordinary_scope_objects8, "AST Declaration scoping - local extern thread_local")
    ...
    ASSERT_OK(kefir_ast_local_context_declare_external_thread_local(&kft_mem, &context, "ext_int1", kefir_ast_type_signed_int(), NULL));
    ASSERT_OK(kefir_ast_local_context_declare_external_thread_local(&kft_mem, &context, "ext_int1", kefir_ast_type_signed_int(), NULL));
    ASSERT_NOK(kefir_ast_local_context_define_static(&kft_mem, &context, "ext_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_NOK(kefir_ast_local_context_define_static_thread_local(&kft_mem, &context, "ext_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_NOK(kefir_ast_local_context_declare_external(&kft_mem, &context, "ext_int1", kefir_ast_type_signed_int(), NULL));
    ASSERT_NOK(kefir_ast_local_context_declare_external_thread_local(&kft_mem, &context, "ext_int1", kefir_ast_type_signed_long(), NULL));
    ASSERT_OK(kefir_ast_local_context_push_block_scope(&kft_mem, &context));
    ASSERT_OK(kefir_ast_local_context_declare_external_thread_local(&kft_mem, &context, "ext_int1", kefir_ast_type_signed_int(), NULL));
    ASSERT_NOK(kefir_ast_local_context_declare_external_thread_local(&kft_mem, &context, "ext_int1", kefir_ast_type_signed_long(), NULL));
    ASSERT_OK(kefir_ast_local_context_push_block_scope(&kft_mem, &context));
    ASSERT_OK(kefir_ast_local_context_define_static_thread_local(&kft_mem, &context, "ext_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_OK(kefir_ast_local_context_push_block_scope(&kft_mem, &context));
    ASSERT_OK(kefir_ast_local_context_declare_external_thread_local(&kft_mem, &context, "ext_int1", kefir_ast_type_signed_int(), NULL));
    ASSERT_NOK(kefir_ast_local_context_declare_external(&kft_mem, &context, "ext_int1", kefir_ast_type_signed_int(), NULL));
    ASSERT_NOK(kefir_ast_local_context_declare_external_thread_local(&kft_mem, &context, "ext_int1", kefir_ast_type_signed_long(), NULL));
...
DEFINE_CASE(ast_ordinary_scope_objects9, "AST Declaration scoping - local static")
    ...
    ASSERT_OK(kefir_ast_local_context_define_static(&kft_mem, &context, "static_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_NOK(kefir_ast_local_context_define_static(&kft_mem, &context, "static_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_NOK(kefir_ast_local_context_declare_external(&kft_mem, &context, "static_int1", kefir_ast_type_signed_int(), NULL));
    ASSERT_OK(kefir_ast_local_context_push_block_scope(&kft_mem, &context));
    ASSERT_OK(kefir_ast_local_context_define_static(&kft_mem, &context, "static_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_NOK(kefir_ast_local_context_define_static(&kft_mem, &context, "static_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_OK(kefir_ast_local_context_push_block_scope(&kft_mem, &context));
    ASSERT_OK(kefir_ast_local_context_define_static_thread_local(&kft_mem, &context, "static_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_NOK(kefir_ast_local_context_define_static_thread_local(&kft_mem, &context, "static_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_OK(kefir_ast_local_context_pop_block_scope(&context));
    ASSERT_NOK(kefir_ast_local_context_define_static(&kft_mem, &context, "static_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_OK(kefir_ast_local_context_pop_block_scope(&context));
    ASSERT_NOK(kefir_ast_local_context_define_static(&kft_mem, &context, "static_int1", kefir_ast_type_signed_int(), NULL, NULL));
...
DEFINE_CASE(ast_ordinary_scope_objects10, "AST Declaration scoping - local static thread_local")
    ...
    ASSERT_OK(kefir_ast_local_context_define_static_thread_local(&kft_mem, &context, "static_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_NOK(kefir_ast_local_context_define_static_thread_local(&kft_mem, &context, "static_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_NOK(kefir_ast_local_context_declare_external_thread_local(&kft_mem, &context, "static_int1", kefir_ast_type_signed_int(), NULL));
    ASSERT_OK(kefir_ast_local_context_push_block_scope(&kft_mem, &context));
    ASSERT_OK(kefir_ast_local_context_define_static_thread_local(&kft_mem, &context, "static_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_NOK(kefir_ast_local_context_define_static_thread_local(&kft_mem, &context, "static_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_OK(kefir_ast_local_context_push_block_scope(&kft_mem, &context));
...
DEFINE_CASE(ast_ordinary_scope_objects11, "AST Declaration scoping - local auto")
    ...
    ASSERT_OK(kefir_ast_local_context_define_auto(&kft_mem, &context, "auto_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_NOK(kefir_ast_local_context_define_auto(&kft_mem, &context, "auto_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_NOK(kefir_ast_local_context_define_static(&kft_mem, &context, "auto_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_NOK(kefir_ast_local_context_define_static_thread_local(&kft_mem, &context, "auto_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_OK(kefir_ast_local_context_push_block_scope(&kft_mem, &context));
    ASSERT_OK(kefir_ast_local_context_define_auto(&kft_mem, &context, "auto_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_OK(kefir_ast_local_context_define_auto(&kft_mem, &context, "auto_int2", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_NOK(kefir_ast_local_context_define_auto(&kft_mem, &context, "auto_int2", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_OK(kefir_ast_local_context_push_block_scope(&kft_mem, &context));
    ASSERT_OK(kefir_ast_local_context_define_auto(&kft_mem, &context, "auto_int2", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_NOK(kefir_ast_local_context_define_register(&kft_mem, &context, "auto_int2", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_OK(kefir_ast_local_context_define_register(&kft_mem, &context, "auto_int3", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_OK(kefir_ast_local_context_push_block_scope(&kft_mem, &context));
    ASSERT_OK(kefir_ast_local_context_define_static(&kft_mem, &context, "auto_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_OK(kefir_ast_local_context_pop_block_scope(&context));
    ASSERT_OK(kefir_ast_local_context_pop_block_scope(&context));
    ASSERT_OK(kefir_ast_local_context_pop_block_scope(&context));
...
DEFINE_CASE(ast_ordinary_scope_objects12, "AST Declaration scoping - local register")
    ...
    ASSERT_OK(kefir_ast_local_context_define_register(&kft_mem, &context, "auto_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_NOK(kefir_ast_local_context_define_register(&kft_mem, &context, "auto_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_NOK(kefir_ast_local_context_define_static(&kft_mem, &context, "auto_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_NOK(kefir_ast_local_context_define_static_thread_local(&kft_mem, &context, "auto_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_OK(kefir_ast_local_context_push_block_scope(&kft_mem, &context));
    ASSERT_OK(kefir_ast_local_context_define_register(&kft_mem, &context, "auto_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_OK(kefir_ast_local_context_define_register(&kft_mem, &context, "auto_int2", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_NOK(kefir_ast_local_context_define_register(&kft_mem, &context, "auto_int2", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_OK(kefir_ast_local_context_push_block_scope(&kft_mem, &context));
    ASSERT_OK(kefir_ast_local_context_define_register(&kft_mem, &context, "auto_int2", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_NOK(kefir_ast_local_context_define_auto(&kft_mem, &context, "auto_int2", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_OK(kefir_ast_local_context_define_auto(&kft_mem, &context, "auto_int3", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_OK(kefir_ast_local_context_push_block_scope(&kft_mem, &context));
    ASSERT_OK(kefir_ast_local_context_define_static(&kft_mem, &context, "auto_int1", kefir_ast_type_signed_int(), NULL, NULL));
    ASSERT_OK(kefir_ast_local_context_pop_block_scope(&context));
    ASSERT_OK(kefir_ast_local_context_pop_block_scope(&context));
...
DEFINE_CASE(ast_ordinary_scope_objects13, "AST Declaration scoping - block scoping")
    ...
    ASSERT_OK(kefir_ast_global_context_define_external(
        &kft_mem, &global_context, "variable3", kefir_ast_type_bool(), NULL, NULL));
    ...
    ASSERT_OK(kefir_ast_global_context_define_static_thread_local(
        &kft_mem, &global_context, "variable5", kefir_ast_type_signed_int(), NULL, NULL));
    ...
    ASSERT_OK(kefir_ast_local_context_define_static(
        &kft_mem, &context, "variable2", kefir_ast_type_float(), NULL, NULL));
    ...
    ASSERT_OK(kefir_ast_local_context_define_auto(
        &kft_mem, &context, "variable10", kefir_ast_type_unsigned_int(), NULL, NULL));
    ...
    ASSERT_OK(kefir_ast_local_context_define_static_thread_local(
        &kft_mem, &context, "variable2", kefir_ast_type_unsigned_int(), NULL, NULL));
...
DEFINE_CASE(ast_ordinary_scope_objects15, "AST Declaration scoping - block externals #2")
    ...
    do {
        ...
        ASSERT_OK(kefir_ast_local_context_declare_external_thread_local(&kft_mem, &context, "array1", array_type2,
            kefir_ast_alignment_const_expression(&kft_mem, kefir_ast_constant_expression_integer(&kft_mem, 2))));
