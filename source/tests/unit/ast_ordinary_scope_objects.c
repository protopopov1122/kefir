...
ASSERT_OK(kefir_ast_global_context_declare_external(&kft_mem, &global_context, "variable1", kefir_ast_type_signed_int(),
                                                    NULL, NULL));
ASSERT_OK(kefir_ast_global_context_declare_external_thread_local(&kft_mem, &global_context, "variable2",
                                                                 kefir_ast_type_signed_long(), NULL, NULL));
ASSERT_OK(kefir_ast_global_context_define_external(&kft_mem, &global_context, "variable1", kefir_ast_type_signed_int(),
                                                   NULL, NULL, NULL));
ASSERT_OK(kefir_ast_global_context_define_external(&kft_mem, &global_context, "variable3", kefir_ast_type_bool(), NULL,
                                                   NULL, NULL));
ASSERT_OK(kefir_ast_global_context_define_static(&kft_mem, &global_context, "variable4", kefir_ast_type_signed_int(),
                                                 NULL, NULL, NULL));
ASSERT_OK(kefir_ast_global_context_declare_external(&kft_mem, &global_context, "variable4", kefir_ast_type_signed_int(),
                                                    NULL, NULL));
...
ASSERT_RESOLVED_IDENTIFIER(&context, "variable1", KEFIR_AST_SCOPE_IDENTIFIER_STORAGE_EXTERN,
                           kefir_ast_type_signed_int(), KEFIR_AST_SCOPED_IDENTIFIER_EXTERNAL_LINKAGE);
ASSERT_OK(kefir_ast_local_context_declare_external(&kft_mem, &context, "variable1", kefir_ast_type_signed_int(), NULL,
                                                   NULL));
ASSERT_RESOLVED_IDENTIFIER(&context, "variable1", KEFIR_AST_SCOPE_IDENTIFIER_STORAGE_EXTERN,
                           kefir_ast_type_signed_int(), KEFIR_AST_SCOPED_IDENTIFIER_EXTERNAL_LINKAGE);
ASSERT_RESOLVED_IDENTIFIER(&context, "variable2", KEFIR_AST_SCOPE_IDENTIFIER_STORAGE_EXTERN_THREAD_LOCAL,
...
ASSERT_OK(kefir_ast_local_context_push_block_scope(&kft_mem, &context));
ASSERT_OK(kefir_ast_local_context_define_register(&kft_mem, &context, "variable10", kefir_ast_type_unsigned_int(), NULL,
                                                  NULL, NULL));
ASSERT_RESOLVED_IDENTIFIER(&context, "variable10", KEFIR_AST_SCOPE_IDENTIFIER_STORAGE_REGISTER,
                           kefir_ast_type_unsigned_int(), KEFIR_AST_SCOPED_IDENTIFIER_NONE_LINKAGE);
ASSERT_OK(kefir_ast_local_context_define_static_thread_local(&kft_mem, &context, "variable2",
