...
ASSERT_OK(kefir_ast_global_context_declare_external(
    ...
    NULL, NULL));
ASSERT_OK(kefir_ast_global_context_declare_external(&kft_mem, &global_context, "z", type1, NULL, NULL));
...
ASSERT_OK(kefir_ast_struct_type_field(&kft_mem, context->symbols, struct_type2, "x", kefir_ast_type_unsigned_long(),
                                      NULL));
ASSERT_OK(kefir_ast_struct_type_field(&kft_mem, context->symbols, struct_type2, "y",
...
ASSERT_OK(kefir_ast_struct_type_field(&kft_mem, context->symbols, struct_type3, "j", kefir_ast_type_double(), NULL));
ASSERT_OK(kefir_ast_struct_type_field(&kft_mem, context->symbols, struct_type3, "k",
...
ASSERT_OK(kefir_ast_struct_type_field(&kft_mem, context->symbols, union_type4, "k",
                                      kefir_ast_type_array(&kft_mem, context->type_bundle, type2,
                                                           kefir_ast_constant_expression_integer(&kft_mem, 3), NULL),
                                      NULL));
...
ASSERT_OK(kefir_ast_local_context_define_auto(&kft_mem, &local_context, "x1", type1, NULL, NULL, NULL));
ASSERT_OK(kefir_ast_local_context_define_auto(&kft_mem, &local_context, "x2", type1, NULL, NULL, NULL));
ASSERT_OK(kefir_ast_local_context_define_auto(&kft_mem, &local_context, "y1", type2, NULL, NULL, NULL));
ASSERT_OK(kefir_ast_local_context_define_auto(&kft_mem, &local_context, "y2", type2, NULL, NULL, NULL));
ASSERT_OK(kefir_ast_local_context_define_auto(&kft_mem, &local_context, "z1", type3, NULL, NULL, NULL));
ASSERT_OK(kefir_ast_local_context_define_auto(&kft_mem, &local_context, "z2", type3, NULL, NULL, NULL));
ASSERT_OK(kefir_ast_local_context_define_auto(&kft_mem, &local_context, "w1", type4, NULL, NULL, NULL));
ASSERT_OK(kefir_ast_local_context_define_auto(&kft_mem, &local_context, "w2", type4, NULL, NULL, NULL));
...
ASSERT_OK(kefir_ast_local_context_declare_external(&kft_mem, &local_context, "a", type1, NULL, NULL));
ASSERT_OK(kefir_ast_local_context_declare_external(&kft_mem, &local_context, "b", type2, NULL, NULL));
ASSERT_OK(kefir_ast_local_context_declare_external(&kft_mem, &local_context, "c", type3, NULL, NULL));
ASSERT_OK(kefir_ast_local_context_declare_external(&kft_mem, &local_context, "d", type4, NULL, NULL));
ASSERT_OK(kefir_ast_local_context_declare_external(&kft_mem, &local_context, "e", type5, NULL, NULL));
ASSERT_OK(kefir_ast_local_context_declare_external(&kft_mem, &local_context, "f", type6, NULL, NULL));
...
ASSERT_OK(kefir_ast_local_context_declare_external(&kft_mem, &local_context, "b", type2, NULL, NULL));
ASSERT_OK(kefir_ast_local_context_declare_external(&kft_mem, &local_context, "c", type3, NULL, NULL));
ASSERT_OK(kefir_ast_local_context_declare_external(&kft_mem, &local_context, "x", type4, NULL, NULL));
ASSERT_OK(kefir_ast_local_context_declare_external(&kft_mem, &local_context, "y", type5, NULL, NULL));
ASSERT_OK(kefir_ast_local_context_declare_external(&kft_mem, &local_context, "z", type6, NULL, NULL));
...
ASSERT_OK(kefir_ast_local_context_declare_external(
    ...
    kefir_ast_type_qualified(&kft_mem, context->type_bundle, kefir_ast_type_bool(),
                             (struct kefir_ast_type_qualification){
