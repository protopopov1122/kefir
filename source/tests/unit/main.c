...
TEST_SUITE(mainSuite,
    ...
    &ast_node_analysis_function_calls3,
    &ast_node_analysis_function_calls4,
    ...
    &ast_node_analysis_add_operator,
    ...
    &ast_structure_declaration1,
    &ast_structure_declaration2,
    &ast_enum_declaration1,
    &ast_enum_declaration2,
    &ast_declarator_analysis1,
    &ast_declarator_analysis2,
    &ast_declarator_analysis3,
    &ast_declarator_analysis4,
    &ast_declarator_analysis5,
    &ast_declarator_analysis6,
    &ast_declarator_analysis7,
    &ast_declarator_analysis8,
    &ast_declarator_analysis9,
    &ast_declarator_analysis10,
    &ast_declarator_analysis11,
    &ast_declarator_analysis12,
    &ast_declarator_analysis13,
    &ast_declarator_analysis14,
    &ast_declarator_analysis15,
    &ast_declarator_analysis16,
    &ast_declarator_analysis17,
    ...
    &ast_node_analysis_declarations10,
