...
DECLARE_CASE(ast_type_analysis_bitfield_promotion1);
...
DECLARE_CASE(ast_declaration_variably_modified_structure_field);
...
DECLARE_CASE(ast_node_analysis_conditional_operator6);
...
DECLARE_CASE(ast_constant_expression_conditional_operator3);
...
DECLARE_CASE(ast_declaration_variably_modified1);
DECLARE_CASE(ast_declaration_variably_modified2);
DECLARE_CASE(ast_declaration_variably_modified3);
DECLARE_CASE(ast_declaration_variably_modified4);
...
DECLARE_CASE(ast_node_analysis_statement_expressions1);
...
DECLARE_CASE(ast_node_analysis_label_address);
DECLARE_CASE(ast_context_preprocessor_extensions1);
DECLARE_CASE(ast_context_global_extensions1);
DECLARE_CASE(ast_context_local_extensions1);
...
DECLARE_CASE(parser_extensions1);
...
TEST_SUITE(
    ...
    &ast_type_analysis_arithmetic_conversion3, &ast_ordinary_scope_objects1, &ast_ordinary_scope_objects2,
    &ast_ordinary_scope_objects3, &ast_ordinary_scope_objects4, &ast_ordinary_scope_objects5,
    &ast_ordinary_scope_objects6, &ast_ordinary_scope_objects7, &ast_ordinary_scope_objects8,
    &ast_ordinary_scope_objects9, &ast_ordinary_scope_objects10, &ast_ordinary_scope_objects11,
    &ast_ordinary_scope_objects12, &ast_ordinary_scope_objects13, &ast_ordinary_scope_objects14,
    &ast_ordinary_scope_objects15, &ast_type_construction1, &ast_type_construction2, &ast_type_construction3,
    &ast_type_construction4, &ast_type_construction5, &ast_type_construction6, &ast_type_construction7,
    &ast_type_construction8, &ast_nodes_constants, &ast_nodes_identifiers, &ast_nodes_string_literals_multibyte,
    &ast_nodes_string_literals_unicode8, &ast_nodes_string_literals_unicode16, &ast_nodes_string_literals_unicode32,
    &ast_nodes_string_literals_wide, &ast_nodes_type_name, &ast_nodes_array_subscripts, &ast_nodes_function_calls,
    &ast_nodes_builtins, &ast_nodes_struct_members, &ast_nodes_unary_operations, &ast_nodes_binary_operations,
    &ast_nodes_generic_selections, &ast_nodes_cast_operators, &ast_nodes_conditional_operators,
    ...
    &ast_node_analysis_simple_assignment_operator1, &ast_node_analysis_simple_assignment_operator2,
    &ast_node_analysis_simple_assignment_operator3, &ast_node_analysis_simple_assignment_operator4,
    &ast_node_analysis_simple_assignment_operator5, &ast_node_analysis_simple_assignment_operator6,
    &ast_node_analysis_simple_assignment_operator7, &ast_node_analysis_compound_assignment_operator1,
    ...
    &ast_constant_expression_conditional_operator3, &ast_constant_expression_cast_operator1,
    &ast_constant_expression_cast_operator2, &ast_translator_environment1, &ast_translator_environment2,
    &ast_alignment_default, &ast_alignment_as_type, &ast_alignment_as_const_expr, &ast_type_analysis_scalars,
    &ast_type_analysis_pointers_qualifications, &ast_type_analysis_enumerations, &ast_type_analysis_arrays,
    &ast_type_analysis_structs, &ast_type_analysis_functions, &ast_type_analysis_flexible_arrays,
    &ast_bitfield_translator1, &ast_bitfield_translator2, &ast_bitfield_translator3, &ast_bitfield_translator4,
    &ast_bitfield_translator5, &ast_declarator_specifier_construction1, &ast_declarator_specifier_construction2,
    &ast_declarator_specifier_construction3, &ast_declarator_specifier_construction4,
    &ast_declarator_specifier_construction5, &ast_declarator_specifier_construction6,
    &ast_declarator_specifier_construction7, &ast_declarator_specifier_construction8,
    &ast_declarator_specifier_construction9, &ast_declarator_specifier_construction10,
    &ast_declarator_specifier_construction11, &ast_declarator_construction1, &ast_declarator_construction2,
    &ast_declarator_construction3, &ast_declarator_construction4, &ast_declarator_construction5,
    &ast_declarator_construction6, &ast_declarator_construction7, &ast_declarator_construction8,
    &ast_declarator_construction9, &ast_declarator_construction10, &ast_declarator_construction11,
    &ast_structure_declaration1, &ast_structure_declaration2, &ast_enum_declaration1, &ast_enum_declaration2,
    &ast_declarator_analysis1, &ast_declarator_analysis2, &ast_declarator_analysis3, &ast_declarator_analysis4,
    &ast_declarator_analysis5, &ast_declarator_analysis6, &ast_declarator_analysis7, &ast_declarator_analysis8,
    &ast_declarator_analysis9, &ast_declarator_analysis10, &ast_declarator_analysis11, &ast_declarator_analysis12,
    &ast_declarator_analysis13, &ast_declarator_analysis14, &ast_declarator_analysis15, &ast_declarator_analysis16,
    &ast_declarator_analysis17, &ast_declarator_analysis18, &ast_declarator_analysis19, &ast_declarator_analysis20,
    &ast_declarator_analysis21, &ast_declarator_analysis22, &ast_declarator_analysis23, &ast_declarator_analysis24,
    &ast_declarator_analysis25, &ast_declaration_variably_modified1, &ast_declaration_variably_modified2,
    &ast_declaration_variably_modified3, &ast_declaration_variably_modified4,
    &ast_declaration_variably_modified_structure_field, &ast_node_analysis_init_declarators1,
    ...
    &parser_lexem_copy, &parser_token_cursor1, &parser_block_scope1, &parser_scope1, &parser_extensions1,
