...
TEST_SUITE(
    ...
    &ast_node_analysis_init_declarators1, &ast_node_analysis_init_declarators2, &ast_node_analysis_init_declarators3,
    &ast_node_analysis_init_declarators4, &ast_node_analysis_init_declarators5, &ast_node_analysis_init_declarators6,
    &ast_node_analysis_init_declarators7, &ast_node_analysis_init_declarators8, &ast_node_analysis_init_declarators9,
    &ast_node_analysis_init_declarators10, &ast_node_analysis_init_declarators11, &ast_node_analysis_init_declarators12,
    &ast_node_analysis_init_declarators13, &ast_node_analysis_static_assertions1,
    &ast_node_analysis_expression_statements1, &ast_node_analysis_labeled_statements1,
    &ast_node_analysis_case_statements1, &ast_label_scope1, &ast_label_scope2, &ast_label_scope3, &ast_label_scope4,
    &ast_node_analysis_labeled_statements2, &ast_nodes_compound_statements1, &ast_node_analysis_compound_statements1,
    &ast_node_analysis_compound_statements2, &ast_node_analysis_compound_statements3,
    &ast_node_analysis_compound_statements4, &ast_nodes_conditional_statements1,
    &valueast_node_analysis_conditional_statements1, &ast_node_analysis_conditinal_statements2,
    &ast_node_analysis_conditinal_statements3, &ast_flow_control_tree1, &ast_flow_control_tree2,
    &ast_flow_control_tree3, &ast_flow_control_tree4, &ast_flow_control_tree5, &ast_flow_control_tree6,
    &ast_nodes_switch_statements1, &ast_node_analysis_switch_statements1, &ast_node_analysis_switch_statements2,
    &ast_node_analysis_switch_statements3, &ast_node_analysis_switch_statements4, &ast_node_analysis_switch_statements5,
    &ast_nodes_while_statements1, &ast_nodes_while_statements2, &ast_nodes_do_while_statements1,
    &ast_nodes_do_while_statements2, &ast_nodes_for_statements1, &ast_nodes_for_statements2, &ast_nodes_for_statements3,
    &ast_nodes_for_statements4, &ast_nodes_for_statements5, &ast_node_analysis_while_statements1,
    &ast_node_analysis_while_statements2, &ast_node_analysis_do_while_statements1,
