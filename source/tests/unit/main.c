...
TEST_SUITE(
    ...
    &ast_node_analysis_label_address, &ast_node_analysis_goto_address_statements1,
    &ast_node_analysis_statement_expressions1, &ast_type_traversal1, &ast_type_traversal2, &ast_type_traversal3,
    ...
    &ast_declarator_analysis24, &ast_declarator_analysis25, &ast_declaration_variably_modified1,
    &ast_declaration_variably_modified2, &ast_declaration_variably_modified3, &ast_declaration_variably_modified4,
