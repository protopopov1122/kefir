...
DEFINE_CASE(ast_ordinary_scope_objects_init1, "AST Declaration initializers - global externals #1")
    ...
    ASSERT_OK(kefir_ast_global_context_define_external(&kft_mem, &global_context,
        "var1", kefir_ast_type_signed_int(), NULL, NULL, NULL));
    ASSERT_RESOLVED_IDENTIFIER(&context, "var1",
        KEFIR_AST_SCOPE_IDENTIFIER_STORAGE_EXTERN, kefir_ast_type_signed_int(), KEFIR_AST_SCOPED_IDENTIFIER_EXTERNAL_LINKAGE);
...
DEFINE_CASE(ast_ordinary_scope_objects_init2, "AST Declaration initializers - global externals #2")
    ...
    struct kefir_ast_initializer *init2 = kefir_ast_new_expression_initializer(&kft_mem,
        KEFIR_AST_NODE_BASE(KEFIR_AST_MAKE_STRING_LITERAL(&kft_mem, "Hello!")));
    ASSERT_NOK(kefir_ast_global_context_define_external(&kft_mem, &global_context,
        "var1", type1, NULL, init2, NULL));
    ASSERT_OK(kefir_ast_initializer_free(&kft_mem, init2));
    ASSERT_RESOLVED_IDENTIFIER(&context, "var1",
        KEFIR_AST_SCOPE_IDENTIFIER_STORAGE_EXTERN, type2, KEFIR_AST_SCOPED_IDENTIFIER_EXTERNAL_LINKAGE);
...
DEFINE_CASE(ast_ordinary_scope_objects_init3, "AST Declaration initializers - global static #1")
    ...
    ASSERT_OK(kefir_ast_global_context_define_static(&kft_mem, &global_context,
        "var1", kefir_ast_type_signed_long(), NULL, NULL, NULL));
    ASSERT_RESOLVED_IDENTIFIER(&context, "var1",
    ...
    ASSERT_OK(kefir_ast_global_context_define_static(&kft_mem, &global_context,
        "var1", kefir_ast_type_signed_long(), NULL, init0, NULL));
    ASSERT_RESOLVED_IDENTIFIER(&context, "var1",
        KEFIR_AST_SCOPE_IDENTIFIER_STORAGE_STATIC, kefir_ast_type_signed_long(), KEFIR_AST_SCOPED_IDENTIFIER_INTERNAL_LINKAGE);
    ...
    ASSERT_NOK(kefir_ast_global_context_define_static(&kft_mem, &global_context,
        "var1", kefir_ast_type_signed_long(), NULL, init1, NULL));
    ASSERT_OK(kefir_ast_initializer_free(&kft_mem, init1));
    ASSERT_RESOLVED_IDENTIFIER(&context, "var1",
        KEFIR_AST_SCOPE_IDENTIFIER_STORAGE_STATIC, kefir_ast_type_signed_long(), KEFIR_AST_SCOPED_IDENTIFIER_INTERNAL_LINKAGE);
