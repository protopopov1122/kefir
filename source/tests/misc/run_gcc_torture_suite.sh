...
CC="$KEFIRCC --feature-missing-function-return-type --feature-designated-init-colons --feature-labels-as-values --feature-implicit-function-decl --feature-empty-structs --feature-ext-pointer-arithmetics --feature-missing-braces-subobj --feature-statement-expressions --feature-omitted-conditional-operand --include $(dirname $0)/torture.h"
